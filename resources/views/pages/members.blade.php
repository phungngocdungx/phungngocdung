...
@section('content')
                    ...
                    <table class="table table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="sort align-middle" scope="col" data-sort="city" style="width:10%;">NGƯỜI DÙNG
                                </th>
                                </th>
                        ...
                        <tbody class="list" id="members-table-body">
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="customer align-middle white-space-nowrap"><a
                                                ...
                                                <div class="avatar avatar-m"><img class="rounded-circle"
                                                        src="{{ $account->platform->logo_path ?? 'N/A' }}" alt="Image" />
                                                </div>
                                                <h6 class="mb-0 ms-3 fw-semibold">{{ $account->platform->name ?? 'N/A' }}
                                                </h6>
                                            </a></td>
                                        <td class="email align-middle white-space-nowrap"><a class="fw-semibold"
                                                href="mailto:annac34@gmail.com">{{ $account->username }}</a></td>
                                        <td class="align-middle white-space-nowrap">
                                            <span class="password-text" id="passwordText-{{ $account->id }}"
                                                data-actual-password="{{ $account->password }}" {{-- <<< ĐỔI TÊN Ở ĐÂY --}}
                                                style="margin-right: 8px; vertical-align: middle;">********</span>
                                            <button type="button" class="btn btn-sm btn-outline-secondary btn-request-pin"
                                                data-bs-toggle="modal" data-bs-target="#verifyPinModal"
                                                data-span-id="passwordText-{{ $account->id }}"
                                                data-button-id="passwordButton-{{ $account->id }}"
                                                id="passwordButton-{{ $account->id }}" title="Hiện mật khẩu"
                                        ...
                                        <td class="mobile_number align-middle white-space-nowrap"><a
                                                class="fw-bold text-body-emphasis" href="tel:+912346578">
                                        ...
                                        <td class="joined align-middle white-space-nowrap text-body-tertiary text-end">
                                            {{ $account->updated_at->format('d/m/Y H:i') }}</td>
                                        <td class="text-end align-middle white-space-nowrap">
                                            <div class="dropdown font-sans-serif position-static">
                                                <button
                                                    ...
                                                    type="button" id="actionsDropdown-{{ $account->id }}"
                                                    data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true"
                                                    aria-expanded="false">
                                                    <span class="fas fa-ellipsis-h" data-fa-transform="shrink-2"></span>
                                                    {{-- Hoặc fas fa-ellipsis-v --}}
                                                </button>
                                                <div class="dropdown-menu dropdown-menu-end border py-2"
                                                    aria-labelledby="actionsDropdown-{{ $account->id }}">
                                                    {{-- MỤC XEM CHI TIẾT --}}
                                                    {{-- <a class="dropdown-item"
                                                        href="{{ route('accounts.show', $account->id) }}">
                                                        <i class="fas fa-eye fa-fw me-2"></i>Xem chi tiết
                                                    </a> --}}

                                                    {{-- MỤC SỬA (ĐÃ BỎ COMMENT VÀ SẴN SÀNG ĐỂ JAVASCRIPT BẮT SỰ KIỆN) --}}
                                                    <a class="dropdown-item btn-edit-account" {{-- Thêm class btn-edit-account để JS dễ bắt hơn nếu cần --}}
                                                        href="{{ route('accounts.edit', $account->id) }}"
                                                        data-account-id="{{ $account->id }}"> {{-- data-attribute để dễ lấy ID bằng JS --}}
                                                    ...
                                                    {{-- <form action="{{ route('accounts.destroy', $account->id) }}"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <i class="fas fa-trash-alt fa-fw me-2"></i>Xóa
                                                        </button>
                                                    </form> --}}
                                                </div>
                                            </div>
                            ...
                            @else
                                @if ($familyMember)
                                    {{-- Chỉ hiển thị thông báo này nếu có familyMember được chọn --}}
                                    <div class="alert alert-info">
                                        <p>{{ $familyMember->name }} chưa có tài khoản nào được lưu trữ.</p>
                                        {{-- <p>Hãy <a href="{{ route('accounts.create') }}">thêm tài khoản mới</a>!</p> --}}
                                    </div>
                                @endif
                            @endif
                        </tbody>
                            ...
                            <div class="modal-body">
                                <form id="verifyPinForm">
                                    <div class="mb-3">
                                        ...
                                        <input type="password" class="form-control" id="globalPinInput"
                                            name="global_pin" maxlength="8" pattern="\d{8}" inputmode="numeric"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <select
                                                class="form-select @error('platform_id', 'storeAccount') is-invalid @enderror"
                                            ...
                                            <button class="btn btn-outline-success" type="button"
                                                id="btnToggleNewPlatformForm" title="Tạo nền tảng mới">
                                    ...
                                    <div id="newPlatformFormContainer" class="p-3 border rounded mb-3 shadow-sm bg-light"
                                        ...
                                        <div id="ajaxNewPlatformSuccess" class="alert alert-success"
                                        ...
                                        <div class="mb-3"> {{-- Tăng mb để có không gian cho nút --}}
                                            ...
                                            <input type="url" class="form-control form-control-sm"
                                                id="ajax_new_platform_logo_path"
                                                placeholder="https://example.com/logo.png">
                                        </div>
                                        <div class="text-end">
                                            <button type="button" class="btn btn-success btn-sm me-2"
                                                id="btnSaveNewPlatformAjax">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-outline-secondary" type="button"
                                                id="toggleAddPassword"><i class="fas fa-eye"></i></button>
                                        </div>
                                    ...
                                    @if (isset($allFamilyMembers) && $allFamilyMembers->count() > 0)
                                        <div class="mb-3">
                                            ...
                                            <select
                                                class="form-select @error('family_member_id', 'storeAccount') is-invalid @enderror"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-xl">
                        <div class="modal-content">
                            ...
                            <form id="editAccountForm" method="POST">
                                ...
                                <input type="hidden" id="edit_family_member_id_for_tab3"
                                    name="family_member_id_for_tab3">

                                <div class="modal-body">
                                    {{-- Nav tabs --}}
                                    <ul class="nav nav-tabs" id="editAccountTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="edit-account-info-tab"
                                                data-bs-toggle="tab" data-bs-target="#editAccountInfo" type="button"
                                                role="tab" aria-controls="editAccountInfo" aria-selected="true">Thông
                                    ...
                                    <div class="tab-content mt-3" id="editAccountTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="editAccountInfo" role="tabpanel"
                                            ...
                                            <div class="text-danger mb-2" id="editAccountFormErrorsTab1"
                                                style="display:none;"></div>
                                            <div class="mb-3">
                                                <label for="edit_platform_id" class="form-label">Nền tảng <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select" id="edit_platform_id" name="platform_id"
                                                    required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <button class="btn btn-outline-secondary" type="button"
                                                        id="toggleEditPasswordVisibility"><i
                                        ...
                                        <div class="tab-pane fade" id="editPlatformInfo" role="tabpanel"
                                            ...
                                            <div class="text-danger mb-2" id="editPlatformFormErrorsTab2"
                                                style="display:none;"></div>
                                        ...
                                        <div class="tab-pane fade" id="editFamilyMemberInfo" role="tabpanel"
                                            ...
                                            <div class="text-danger mb-2" id="editFamilyMemberFormErrorsTab3"
                                                style="display:none;"></div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password" class="form-control"
                                                    id="edit_fm_master_password_confirmation"
                                                    name="family_member_master_password_confirmation"
                                                    autocomplete="new-password">
                                            </div>
                                        </div>
                                    </div>
    ...
    {{-- Đặt đoạn script này ở cuối file resources/views/accounts/index.blade.php --}}
    {{-- Hoặc @section('scripts') nếu layout của bạn có yield('scripts') --}}
    {{-- Đặt ở cuối file resources/views/accounts/index.blade.php, bên trong @endsection nếu có --}}
    {{-- Hoặc nếu bạn dùng @push('scripts') thì đặt trong đó --}}
