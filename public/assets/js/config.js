(function(global, factory) {
    ...
    "dark" === localStorage.getItem("phoenixTheme") ? document.documentElement.setAttribute("data-bs-theme", "dark") : "auto" === localStorage.getItem("phoenixTheme") && document.documentElement.setAttribute("data-bs-theme", window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"),
    "horizontal" === localStorage.getItem("phoenixNavbarPosition") && document.documentElement.setAttribute("data-navigation-type", "horizontal"),
    "combo" === localStorage.getItem("phoenixNavbarPosition") && document.documentElement.setAttribute("data-navigation-type", "combo");
    var config = {
        config: CONFIG,
        reset: resetConfig,
        set: setConfig
