...
!function() {
    ...
    e => e.replace(Do, ""))
      ...
      , wt = e => {
        ...
        return yt(ze(t)).fold(( () => o.body.contains(t)), (n = wt,
        s = xt,
        e => n(s(e))));
        var n, s
    }
      ...
      , Pt = (e, t) => {
        const o = e.dom;
        Bt(o, t),
        xe(Et(e, "style").map(Me), "") && Mt(e, "style")
    }
      ...
      , Kt = e => {
        const t = e.dom.ownerDocument
          ...
          , s = t.documentElement;
        if (o === e.dom)
            return Yt(o.offsetLeft, o.offsetTop);
      ...
      , Jt = e => {
        ...
        return o === t ? Yt(o.offsetLeft, o.offsetTop) : wt(e) ? (e => {
    ...
    const cn = (e, t, o) => e.stype === ln.Error ? t(e.serror) : o(e.svalue)
      ...
      , _n = e => ({
        extract: (t, o) => ( (e, t) => e.stype === ln.Error ? t(e.serror) : e)(e(o), (e => ( (e, t) => On(e, x(t)))(t, e))),
        toString: x("val")
    })
      , Tn = _n(mn)
      ...
      , An = (e, t, o, n, s) => {
        const r = e => s.extract(t.concat([n]), e)
          , a = e => e.fold(( () => mn(A.none())), (e => ( (e, t) => e.stype === ln.Value ? {
            stype: ln.Value,
            svalue: t(e.svalue)
        } : e)(s.extract(t.concat([n]), e), A.some)));
        switch (e.tag) {
        case "required":
            return ( (e, t, o, n) => be(t, o).fold(( () => ( (e, t, o) => On(e, ( () => 'Could not find valid *required* value for "' + t + '" in ' + Cn(o))))(e, o, t)), n))(t, o, n, r);
        case "defaultedThunk":
      ...
      , In = e => ({
        ...
        toString: () => {
            const t = V(e, (e => fn(e, ( (e, t, o, n) => e + " -> " + n.toString()), ( (e, t) => "state(" + e + ")"))));
            return "obj{\n" + t.join("\n") + "}"
        }
    })
      , Fn = e => ({
      ...
      , $n = (e, t) => ({
        extract: (o, n) => be(n, e).fold(( () => ( (e, t) => On(e, ( () => 'Choice schema did not contain choice key: "' + t + '"')))(o, e)), (e => ( (e, t, o, n) => be(o, n).fold(( () => ( (e, t, o) => On(e, ( () => 'The chosen schema: "' + o + '" did not exist in branches: ' + Cn(t))))(e, o, n)), (o => o.extract(e.concat(["branch: " + n]), t))))(o, n, t, e))),
        toString: () => "chooseOn(" + e + "). Possible values: " + ae(t)
    })
      , qn = e => _n((t => e(t).fold(gn, mn)))
      , Yn = (e, t) => Nn((t => e(t).fold(un, dn)), t)
      , Xn = (e, t, o) => {
        return n = ( (e, t, o) => ( (e, t) => e.stype === ln.Error ? {
            stype: ln.Error,
            serror: t(e.serror)
        } : e)(t.extract([e], o), (e => ({
            input: o,
        ...
        value: Vs({
            can: (e, t) => {
                const o = t.event
                  , n = o.originator
                  , s = o.target;
                return !( (e, t, o) => et(t, e.element) && !et(t, o))(e, n, s) || (console.warn(cr() + " did not get interpreted by the desired target. \nOriginator: " + ra(n) + "\nTarget: " + ra(s) + "\nCheck the " + cr() + " event handlers"),
                !1)
            }
        })
    }))(cr())]);
    var ia, la = Object.freeze({
        __proto__: null,
        events: aa
    });
    let ca = 0;
    const da = e => {
      ...
      , pa = ma()
      , ha = (e, t) => {
        Object.defineProperty(e.dom, pa, {
            value: t,
            writable: !0
        })
    }
      ...
      , ka = da("alloy-premade")
      , Ca = e => (Object.defineProperty(e.element.dom, ka, {
        value: e.uid,
        writable: !0
    }),
    Bs(ka, e))
      ...
      , Fa = (e, t, o) => {
        ...
        )(V(e, (e => e.handler))))) : ( (e, t) => an.error(["The event (" + e + ') has more than one behaviour that listens to it.\nWhen this occurs, you must specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that can trigger it are: ' + JSON.stringify(V(t, (e => e.name)), null, 2)]))(o, e)
    }
      , Ra = (e, t) => ( (e, t) => {
        const o = (e => {
            const t = []
        ...
        an.error(q(n))) : ( (e, t) => 0 === e.length ? an.value(t) : an.value(vn(t, yn.apply(void 0, e))))(o.values, t);
        var n
    }
    )(pe(e, ( (e, o) => (1 === e.length ? an.value(e[0].handler) : Fa(e, t, o)).map((n => {
        const s = (e => {
            const t = (e => p(e) ? {
                can: E,
                abort: T,
      ...
      , La = In([ts("dom", "dom", {
        tag: "required",
        process: {}
    }, In([ss("tag"), ws("styles", {}), ws("classes", []), ws("attributes", {}), gs("value"), gs("innerHtml")])), ss("components"), ss("uid"), ws("events", {}), ws("apis", {}), ts("eventOrder", "eventOrder", (mi = {
    ...
    Sn(x(mi))), zn()), gs("domModification")])
      ...
      , Ua = (e, t) => ( (e, t, o) => {
        ...
        return Ot(e, t, n.join(" ")),
        !0
    }
    )(e, "class", t)
      , Wa = (e, t) => ( (e, t, o) => {
        const n = U(Va(e, t), (e => e !== o));
        return n.length > 0 ? Ot(e, t, n.join(" ")) : Mt(e, t),
        !1
    }
    )(e, "class", t)
      , ja = (e, t) => {
      ...
      , $a = (e, t) => {
        Ha(e) ? e.dom.classList.remove(t) : Wa(e, t),
        Ga(e)
    }
      ...
      , ei = (e, t, o) => {
        const n = V(t, o)
          , s = ct(e);
        return H(s.slice(n.length), Wo),
        n
    }
      , ti = (e, t, o, n) => {
        const s = dt(e, t)
          , r = n(o, s)
          , a = ( (e, t, o) => dt(e, t).map((e => {
      ...
      , ni = (e, t) => {
        const o = t.filter((t => We(t) === e.tag && !(e => e.innerHtml.isSome() && e.domChildren.length > 0)(e) && !(e => ve(e.dom, ka))(t))).bind((t => ( (e, t) => {
            try {
                const o = ( (e, t) => {
      ...
      , li = ba
      , ci = (e, t) => Oa(e).getOrThunk(( () => ( (e, t) => {
        const {events: o, ...n} = va(e)
          , s = ( (e, t) => {
            const o = be(e, "components").getOr([]);
            return t.fold(( () => V(o, di)), (e => V(o, ( (t, o) => ci(t, dt(e, o))))))
        }
        )(n, t)
          , r = {
            ...n,
      ...
      , di = e => ci(e, A.none())
      , ui = Ca;
    var mi, gi = (e, t, o, n, s) => e(o, n) ? A.some(o) : p(s) && s(o) ? A.none() : t(o, n, s);
    const pi = (e, t, o) => {
        let n = e.dom;
        const s = p(o) ? o : T;
        for (; n.parentNode; ) {
      ...
      , Oi = (e, t) => bi(t, (t => et(t, e.element)), T) || ( (e, t) => (e => hi(e, (e => {
        if (!$e(e))
            return !1;
        const t = Tt(e, "id");
                ...
                const n = ( (e, t) => {
                    ...
                    return {
                        ...
                        write: () => {
                            ...
                            R(["mousemove", "mouseover", "mouseout", yr()], e) || console.log(e, {
                                event: e,
                                time: s - n,
                                target: t.dom,
                                sequence: V(o, (e => R(["cut", "stopped", "response"], e.outcome) ? "{" + e.purpose + "} " + e.outcome + " at (" + ra(e.target) + ")" : e.outcome))
                            })
                        }
                    }
                }
    ...
    ts(t, t, o, qn((e => an.value(( (...t) => e.apply(void 0, t)))))))
      , zi = e => Li(0, e, wn(b))
      ...
      , nl = (e, t) => Z(["left", "right", "top", "bottom"], (o => be(t, o).map((t => ( (e, t) => {
        switch (t) {
        case 1:
            return e.x;
        case 0:
      ...
      , ul = (e, t, o) => Gi(rl(e), cl(e), o.southeast(), qi(), "southeast", nl(e, {
        left: 1,
        top: 3
    }), sl)
      , ml = (e, t, o) => Gi(il(e, t), cl(e), o.southwest(), Yi(), "southwest", nl(e, {
        right: 0,
        top: 3
    }), sl)
      , gl = (e, t, o) => Gi(rl(e), ll(e, t), o.northeast(), Xi(), "northeast", nl(e, {
        left: 1,
        bottom: 2
    }), sl)
      , pl = (e, t, o) => Gi(il(e, t), ll(e, t), o.northwest(), Ki(), "northwest", nl(e, {
        right: 0,
        bottom: 2
    }), sl)
      , hl = (e, t, o) => Gi(al(e, t), ll(e, t), o.north(), Zi(), "north", nl(e, {
        bottom: 2
    }), sl)
      , fl = (e, t, o) => Gi(al(e, t), cl(e), o.south(), Ji(), "south", nl(e, {
        top: 3
    }), sl)
      , bl = (e, t, o) => Gi((e => e.x + e.width)(e), dl(e, t), o.east(), Qi(), "east", nl(e, {
        left: 0
    }), sl)
      , vl = (e, t, o) => Gi(( (e, t) => e.x - t.width)(e, t), dl(e, t), o.west(), el(), "west", nl(e, {
        right: 1
    }), sl)
    ...
    const zl = (e, t=!1) => e.dom.focus({
      ...
      , ql = (e, t, o, n, s, r) => {
        const a = t.rect
          ...
          , p = A.some(d)
          , h = A.none();
        return t.direction.fold(( () => jl(e, u, m, h, h)), ( () => jl(e, h, m, g, h)), ( () => jl(e, u, h, h, p)), ( () => jl(e, h, h, g, p)), ( () => jl(e, u, m, h, h)), ( () => jl(e, u, h, h, p)), ( () => jl(e, u, m, h, h)), ( () => jl(e, h, m, g, h)))
    }
      , Yl = (e, t) => e.fold(( () => {
        const e = t.rect;
        return jl("absolute", A.some(e.x), A.some(e.y), A.none(), A.none())
    }
    ), ( (e, o, n, s) => ql("absolute", t, e, o, n, s)), ( (e, o, n, s) => ql("fixed", t, e, o, n, s)))
      , Xl = (e, t) => {
        const o = k(Jo, t)
          , n = e.fold(o, o, ( () => {
            const e = jo();
      ...
      , Kl = (e, t) => t.fold(( () => e.fold(on, on, Zo)), (t => e.fold(x(t), x(t), ( () => {
    ...
    ;
    var Mc = [ss("hotspot"), gs("bubble"), ws("overrides", {}), Ec(), Ui("placement", ( (e, t, o) => {
        const n = t.hotspot
          , s = Xl(o, n.element)
      ...
      , Dc = [ss("x"), ss("y"), ws("height", 0), ws("width", 0), ws("bubble", wc()), ws("overrides", {}), Ec(), Ui("placement", ( (e, t, o) => {
    ...
    var Uc = [ss("node"), ss("root"), gs("bubble"), Ec(), ws("overrides", {}), ws("showAbove", !1), Ui("placement", ( (e, t, o) => {
        const n = Vc(e, 0, t);
    ...
    e => e.fold(w, w, w))
      ...
      , Qc = (e, t) => ( (e, t) => {
        ...
        return ( (e, t) => {
            const o = t.ltr();
            return o.collapsed ? t.rtl().filter((e => !1 === e.collapsed)).map((e => Jc.rtl(ze(e.endContainer), e.endOffset, ze(e.startContainer), e.startOffset))).getOrThunk(( () => Zc(0, Jc.ltr, o))) : Zc(0, Jc.ltr, o)
        }
        )(0, o)
    }
    )(e, t).match({
    ...
    const ed = (e, t, o) => U(( (e, t) => {
      ...
      , nd = e => {
            ...
            return od(e);
        {
            ...
            )(t, e.anchorOffset, o, e.focusOffset) ? A.some(Wc(t, e.anchorOffset, o, e.focusOffset)) : od(e)
        }
    }
      , sd = (e, t) => (e => {
      ...
      , cd = (e, t) => t.getSelection.getOrThunk(( () => () => (e => (e => A.from(e.getSelection()))(e).filter((e => e.rangeCount > 0)).bind(nd))(e)))().map((e => {
        if (ld(e)) {
    ...
    var dd = [gs("getSelection"), ss("root"), gs("bubble"), Ec(), ws("overrides", {}), ws("showAbove", !1), Ui("placement", ( (e, t, o) => {
        const n = rt(t.root).dom
          ...
          , a = cd(n, t).bind((e => ld(e) ? $e(e.start) ? A.some(e.start) : it(e.start) : A.some(e.firstCell))).getOr(e.element);
        return Pc(r, s, t, o, a)
    }
    ))];
    const ud = "link-layout"
      ...
      , hd = e => e.y
      , fd = (e, t, o) => Gi(md(e), hd(e), o.southeast(), qi(), "southeast", nl(e, {
        left: 0,
        top: 2
    }), ud)
      , bd = (e, t, o) => Gi(gd(e, t), hd(e), o.southwest(), Yi(), "southwest", nl(e, {
        right: 1,
        top: 2
    }), ud)
      , vd = (e, t, o) => Gi(md(e), pd(e, t), o.northeast(), Xi(), "northeast", nl(e, {
        left: 0,
        bottom: 3
    }), ud)
      , yd = (e, t, o) => Gi(gd(e, t), pd(e, t), o.northwest(), Ki(), "northwest", nl(e, {
        right: 1,
        bottom: 3
    }), ud)
      , xd = () => [fd, bd, vd, yd]
      , wd = () => [bd, fd, yd, vd];
    var Sd = [ss("item"), Ec(), ws("overrides", {}), Ui("placement", ( (e, t, o) => {
    ...
    const Cd = [ms("classes", Pn), Os("mode", "all", ["all", "layout", "placement"])]
      ...
      , Td = (e, t, o, n, s, r) => {
        ...
        Wl(( () => {
            ...
            zt(l, "left").isNone() && zt(l, "top").isNone() && zt(l, "right").isNone() && zt(l, "bottom").isNone() && xe(zt(l, "position"), "fixed") && Pt(l, "position")
        }
        ), l)
    }
    ;
    ...
    const Ad = Bl({
      ...
      , Kd = (e, t, o) => {
        ...
        ( (e, t, o) => {
            Et(e.element, o).fold(( () => Pt(e.element, t)), (o => It(e.element, t, o)))
        }
        )(e, "visibility", t.cloakVisibilityAttr)
    }
    ;
    ...
    const tu = Bl({
      ...
      , au = e => {
        ...
        return {
            [ou()]: {
                schema: Bn([ss("target")]),
                onReceive: (e, o) => {
                    tu.isOpen(e) && (tu.isPartOf(e, o.target) || t.isExtraPart(e, o.target) || t.fireEventInstead.fold(( () => tu.close(e)), (t => Rr(e, t.event))))
                }
            }
        }
    }
      ...
      , lu = e => {
        ...
        return {
            [nu()]: {
                onReceive: e => {
                    tu.isOpen(e) && t.fireEventInstead.fold(( () => t.doReposition(e)), (t => Rr(e, t.event)))
                }
            }
        }
    }
    ...
    ;
    var bu = [gs("initialValue"), ss("getFallbackEntry"), ss("getDataKey"), ss("setValue"), Ui("manager", {
        setValue: fu,
        getValue: (e, t, o) => {
            const n = t.store
              , s = n.getDataKey(e);
      ...
      , vu = [ss("getValue"), ws("setValue", b), gs("initialValue"), Ui("manager", {
        setValue: (e, t, o, n) => {
    ...
    const wu = Bl({
      ...
      , Au = e => ve(e, "uiType")
      , Mu = (e, t, o, n) => ( (e, t, o, n) => Au(o) && o.uiType === Tu ? ( (e, t, o, n) => e.exists((e => e !== o.owner)) ? Eu.single(!0, x(o)) : be(n, o.name).fold(( () => {
        throw new Error("Unknown placeholder component: " + o.name + "\nKnown: [" + ae(n) + "]\nNamespace: " + e.getOr("none") + "\nSpec: " + JSON.stringify(o, null, 2))
    }
    ), (e => e.replace())))(e, 0, o, n) : Eu.single(!1, x(o)))(e, 0, o, n).fold(( (s, r) => {
      ...
      , Nu = ws("schema", [])
      , Lu = ss("name")
      , zu = ts("pname", "pname", xn((e => "<alloy." + da(e.name) + ">")), zn())
    ...
    const tm = (e, t, o, n) => vn(t.defaults(e, o, n), o, {
      ...
      , rm = e => Y(e, (e => e.fold(A.none, A.some, A.none, A.none).map((e => ds(e.name, e.schema.concat([Wi(Qu())])))).toArray()))
      , am = e => V(e, qu)
      , im = (e, t, o) => ( (e, t, o) => {
        const n = {}
          , s = {};
      ...
      , fm = e => ts("partUids", "partUids", Sn((t => hm(t.uid, e))), zn());
    ...
    const vm = (e, t, o, n, s) => {
        const r = ( (e, t) => (e.length > 0 ? [ds("parts", e)] : []).concat([ss("uid"), ws("dom", {}), ws("components", []), Wi("originalSpec"), ws("debug.sketcher", {})]).concat(t))(n, s);
    ...
    const Um = Bl({
      ...
      , Wm = (e, t, o, n) => {
        ...
        H(s, (o => {
            N(n, (e => et(e.element, o))) || ($a(o, t.highlightClass),
      ...
      , jm = (e, t, o, n) => {
        Wm(e, t, 0, [n]),
        Gm(e, t, o, n) || (ja(n.element, t.highlightClass),
        t.onHighlight(e, n),
        Rr(n, Ir()))
    }
    ...
    var Km = Object.freeze({
        ...
        dehighlight: (e, t, o, n) => {
            Gm(e, t, o, n) && ($a(n.element, t.highlightClass),
            t.onDehighlight(e, n),
            Rr(n, Fr()))
        }
        ,
    ...
    const Zm = Bl({
      ...
      , vg = (e, t, o) => {
        t.exists((e => o.exists((t => et(t, e))))) || Nr(e, Er(), {
            prevFocus: t,
            newFocus: o
        })
    }
    ...
    const Sg = (e, t, o, n, s) => {
        const r = (e, t, o, n, s) => {
          ...
          , a = {
            schema: () => e.concat([ws("focusManager", yg()), Ss("focusInside", "onFocus", qn((e => R(["onFocus", "onEnterOrSpace", "onApi"], e) ? an.value(e) : an.error("Invalid value for focusInside")))), Ui("handler", a), Ui("state", t), Ui("sendFocusIn", s)]),
            processKey: r,
            toEvents: (e, t) => {
                const a = e.focusInside !== wg.OnFocusMode ? A.none() : s(e).map((o => jr(cr(), ( (n, s) => {
                    o(n, e, t),
                    s.stop()
                }
                ))))
                  , i = [jr(Zs(), ( (n, a) => {
                    r(n, a, o, e, t).fold(( () => {
                        ( (o, n) => {
                            ...
                            e.focusInside === wg.OnEnterOrSpaceMode && r && Ls(o, n) && s(e).each((s => {
                                s(o, e, t),
                                n.stop()
                            }
                            ))
      ...
      , kg = e => {
        const t = [gs("onEscape"), gs("onEnter"), ws("selector", '[data-alloy-tabstop="true"]:not(:disabled)'), ws("firstTabstop", 0), ws("useTabstopAt", E), gs("visibilitySelector")].concat([e])
          ...
          , r = (e, t, s, r) => {
            ...
            return n(e, s).bind((t => $(a, k(et, t)).bind((t => ( (e, t, n, s, r) => r(t, n, (e => ( (e, t) => o(e, t) && e.useTabstopAt(t))(s, e))).fold(( () => s.cyclic ? A.some(!0) : A.none()), (t => (s.focusManager.set(e, t),
            A.some(!0)))))(e, a, t, s, r)))))
        }
          , a = (e, t, o) => {
          ...
          , c = x([bg(mg(og), ( (e, t, o) => o.onEscape.bind((o => o(e, t))))), bg(mg(eg), ( (e, t, o) => n(e, o).filter((e => !o.useTabstopAt(e))).bind((n => ((e => (e => at(e))(e).bind(ut).exists((t => et(t, e))))(n) ? a : i)(e, t, o)))))]);
        return Sg(t, Ta.init, l, c, ( () => A.some(s)))
    }
    ;
    var Cg = kg(os("cyclic", T))
      , Og = kg(os("cyclic", E));
    const _g = (e, t, o) => Om(o) && mg(ng)(t.event) ? A.none() : ( (e, t, o) => (zr(e, o, gr()),
    A.some(!0)))(e, 0, o)
      , Tg = (e, t) => A.some(!0)
      , Eg = [ws("execute", _g), ws("useSpace", !1), ws("useEnter", !0), ws("useControlEnter", !1), ws("useDown", !1)]
      , Ag = (e, t, o) => o.execute(e, t, e.element);
    var Mg = Sg(Eg, Ta.init, ( (e, t, o, n) => {
    ...
    ), ( (e, t, o, n) => o.useSpace && !Om(e.element) ? [bg(mg(ng), Tg)] : []), ( () => A.none()));
    const Dg = () => {
        const e = ac();
        return Ea({
    ...
    const Ig = e => (t, o, n, s) => {
      ...
      , Lg = (e, t, o, n, s) => n.focusManager.get(t).bind((o => e(t.element, o, n, s))).map((e => (n.focusManager.set(t, e),
    !0)))
      , zg = Ng
      , Vg = Ng
      , Hg = Ng
      ...
      , Ug = (e, t, o) => {
        const n = td(e, o);
        return ( (e, o) => $(e, (e => et(e, t))).map((t => ({
            index: t,
            candidates: e
        }))))(U(n, Pg))
    }
      , Wg = (e, t) => $(e, (e => et(t, e)))
      , jg = (e, t, o, n) => n(Math.floor(t / o), t % o).bind((t => {
        const n = t.row * o + t.column;
        return n >= 0 && n < e.length ? A.some(e[n]) : A.none()
    }
    ))
      , Gg = (e, t, o, n, s) => jg(e, t, n, ( (t, r) => {
      ...
      , Xg = e => (t, o, n, s) => Ug(t, o, n.selector).bind((t => e(t.candidates, t.index, s.getNumRows().getOr(n.initSize.numRows), s.getNumColumns().getOr(n.initSize.numColumns))))
      ...
      , tp = x([bg(mg(sg), Fg(Jg, Zg)), bg(mg(ag), Rg(Jg, Zg)), bg(mg(rg), zg(Qg)), bg(mg(ig), Vg(ep)), bg(gg([pg, mg(eg)]), Kg), bg(gg([fg, mg(eg)]), Kg), bg(mg(ng.concat(tg)), ( (e, t, o, n) => ( (e, t) => t.focusManager.get(e).bind((e => Si(e, t.selector))))(e, o).bind((n => o.execute(e, t, n)))))])
    ...
    const sp = (e, t, o, n, s) => {
      ...
      , rp = (e, t, o, n) => sp(e, t, o, n, ( (e, t, o, n, s, r, a) => {
        const i = ol(t + o, n, s);
        return i === e ? A.from(r) : a(i)
    }
    ))
      , ap = (e, t, o, n) => sp(e, t, o, n, ( (e, t, o, n, s, r, a) => {
        const i = tl(t, o, n, s);
        return i === e ? A.none() : a(i)
    }
    ))
      , ip = [ss("selector"), ws("getInitial", A.none), ws("execute", _g), Vi("onEscape"), ws("executeOnMove", !1), ws("allowVertical", !0), ws("allowHorizontal", !0), ws("cycles", !0)]
      , lp = (e, t, o) => ( (e, t) => t.focusManager.get(e).bind((e => Si(e, t.selector))))(e, o).bind((n => o.execute(e, t, n)))
      , cp = (e, t, o) => {
        t.getInitial(e).orThunk(( () => wi(e.element, t.selector))).each((o => {
            t.focusManager.set(e, o)
        }
        ))
    }
    ...
    const hp = (e, t, o) => A.from(e[t]).bind((e => A.from(e[o]).map((e => ({
        rowIndex: t,
        columnIndex: o,
        cell: e
    })))))
      ...
      , kp = Sp(( (e, t, o) => fp(e, t, o, -1)), ( (e, t, o) => vp(e, t, o, -1)))
      , Cp = Sp(( (e, t, o) => fp(e, t, o, 1)), ( (e, t, o) => vp(e, t, o, 1)))
      , Op = Sp(( (e, t, o) => bp(e, o, t, -1)), ( (e, t, o) => yp(e, o, t, -1)))
      , _p = Sp(( (e, t, o) => bp(e, o, t, 1)), ( (e, t, o) => yp(e, o, t, 1)))
      , Tp = x([bg(mg(sg), Fg(kp, Cp)), bg(mg(ag), Rg(kp, Cp)), bg(mg(rg), zg(Op)), bg(mg(ig), Vg(_p)), bg(mg(ng.concat(tg)), ( (e, t, o) => Ul(e.element).bind((n => o.execute(e, t, n)))))])
      , Ep = x([bg(mg(ng), Tg)]);
    ...
    const Mp = [ss("selector"), ws("execute", _g), ws("moveOnTab", !1)]
      ...
      , Rp = x([bg(mg(rg), Hg(Ip)), bg(mg(ig), Hg(Fp)), bg(gg([pg, mg(eg)]), ( (e, t, o, n) => o.moveOnTab ? Hg(Ip)(e, t, o, n) : A.none())), bg(gg([fg, mg(eg)]), ( (e, t, o, n) => o.moveOnTab ? Hg(Fp)(e, t, o, n) : A.none())), bg(mg(tg), Dp), bg(mg(ng), Dp)])
      , Np = x([bg(mg(ng), Tg)]);
    var Lp = Sg(Mp, Ta.init, Rp, Np, ( () => A.some(Bp)));
    const zp = [Vi("onSpace"), Vi("onEnter"), Vi("onShiftEnter"), Vi("onLeft"), Vi("onRight"), Vi("onTab"), Vi("onShiftTab"), Vi("onUp"), Vi("onDown"), Vi("onEscape"), ws("stopSpaceKeyup", !1), gs("focusIn")];
    var Vp = Sg(zp, Ta.init, ( (e, t, o) => [bg(mg(ng), o.onSpace), bg(gg([fg, mg(tg)]), o.onEnter), bg(gg([pg, mg(tg)]), o.onShiftEnter), bg(gg([pg, mg(eg)]), o.onShiftTab), bg(gg([fg, mg(eg)]), o.onTab), bg(mg(rg), o.onUp), bg(mg(ig), o.onDown), bg(mg(sg), o.onLeft), bg(mg(ag), o.onRight), bg(mg(ng), o.onSpace)]), ( (e, t, o) => [...o.stopSpaceKeyup ? [bg(mg(ng), Tg)] : [], bg(mg(og), o.onEscape)]), (e => e.focusIn));
    const Hp = Cg.schema()
      , Pp = Og.schema()
      , Up = pp.schema()
      , Wp = np.schema()
      ...
      , Xp = (e, t) => {
        Wl(( () => {
            ( (e, t, o) => {
                ...
                H(s, (t => {
                    Md(t) ? Rd(e, t) : (e.getSystem().addToWorld(t),
                    Rd(e, t),
                    wt(e.element) && Bd(t))
                }
                )),
      ...
      , th = (e, t, o, n, s) => {
        const r = eh(e);
        return A.from(r[n]).map((o => (s.fold(( () => Vd(o)), (s => {
    ...
    var ah = Object.freeze({
      ...
      , ih = Object.freeze({
        ...
        ))].concat(e.stopMousedown ? [jr(Gs(), ( (e, t) => {
            t.event.prevent()
        }
        ))] : []))
    })
    ...
    ;
    var fh = [ws("selected", !1), gs("toggleClass"), ws("toggleOnExecute", !0), zi("onToggled"), Ss("aria", {
        mode: "none"
    }, Qn("mode", {
        pressed: [ws("syncWithExpanded", !1), Ui("update", ( (e, t, o) => {
            Ot(e.element, "aria-pressed", o),
            t.syncWithExpanded && hh(e, 0, o)
        }
        ))],
        checked: [Ui("update", ( (e, t, o) => {
            Ot(e.element, "aria-checked", o)
        }
        ))],
        expanded: [Ui("update", hh)],
        selected: [Ui("update", ( (e, t, o) => {
    ...
    const vh = () => {
      ...
      , kh = e => {
        (Ul(e.element).isNone() || ch.isFocused(e)) && (ch.isFocused(e) || ch.focus(e),
        Nr(e, xh, {
            item: e
        }))
    }
      ...
      , Ah = [ss("data"), ss("components"), ss("dom"), ws("hasSubmenu", !1), gs("toggling"), Ou("itemBehaviours", [bh, ch, Yp, wu]), ws("ignoreFocus", !1), ws("domModification", {}), Ui("builder", (e => ({
        dom: e.dom,
        domModification: {
            ...e.domModification,
            attributes: {
        ...
        behaviours: _u(e.itemBehaviours, [e.toggling.fold(bh.revoke, (e => bh.config((e => ({
            aria: {
                mode: "checked"
            },
      ...
      , Mh = [ss("dom"), ss("components"), Ui("builder", (e => ({
        dom: e.dom,
        components: e.components,
        events: Pr([Kr(pr())])
    })))]
      ...
      , Ih = [ss("uid"), ss("data"), ss("components"), ss("dom"), ws("autofocus", !1), ws("ignoreFocus", !1), Ou("widgetBehaviours", [wu, ch, Yp]), ws("domModification", {}), fm(Bh()), Ui("builder", (e => {
        const t = im(Dh(), e, Bh())
          , o = lm(Dh(), e, t.internals())
          , n = t => cm(t, e, "widget").map((e => (Yp.focusIn(e),
        e)))
          , s = (t, o) => Om(o.event.target) ? A.none() : e.autofocus ? (o.setSource(t.element),
        A.none()) : A.none();
        return {
            dom: e.dom,
            components: o,
            ...
            behaviours: _u(e.widgetBehaviours, [wu.config({
                store: {
                    mode: "memory",
                    initialValue: e.data
                }
                ...
                onLeft: s,
                onRight: s,
                onEscape: (t, o) => ch.isFocused(t) || e.autofocus ? e.autofocus ? (o.setSource(t.element),
                A.none()) : A.none() : (ch.focus(t),
                A.some(!0))
            })])
        }
    }
      ...
      , Nh = x([ss("value"), ss("items"), ss("dom"), ss("components"), ws("eventOrder", {}), Su("menuBehaviours", [Zm, wu, Em, Yp]), Ss("movement", {
        mode: "menu",
        moveOnTab: !0
    }, Qn("mode", {
        grid: [ji(), Ui("config", ( (e, t) => ({
            mode: "flatgrid",
        ...
        matrix: [Ui("config", ( (e, t) => ({
            ...
            focusManager: e.focusManager
        }))), ss("rowSelector"), ws("previousSelector", A.none)],
        menu: [ws("moveOnTab", !0), Ui("config", ( (e, t) => ({
            mode: "menu",
            selector: "." + e.markers.item,
            moveOnTab: t.moveOnTab,
            focusManager: e.focusManager
        })))]
    })), rs("markers", Ii()), ws("fakeFocus", !1), ws("focusManager", yg()), zi("onHighlight"), zi("onDehighlight")])
      ...
      , zh = Cm({
        ...
        factory: (e, t, o, n) => ({
            ...
            dom: e.dom,
            markers: e.markers,
            behaviours: Cu(e.menuBehaviours, [Zm.config({
            ...
            events: Pr([jr(_h(), ( (e, t) => {
                ...
                n && "menuitemradio" === Tt(o.element, "role") && ( (e, t) => {
                    const o = td(e.element, '[role="menuitemradio"][aria-checked="true"]');
                    H(o, (o => {
                        et(o, t.element) || e.getSystem().getByDom(o).each((e => {
                            bh.off(e)
                        }
                        ))
                    }
    ...
    const $h = x("collapse-item")
      , qh = km({
        name: "TieredMenu",
        configFields: [Pi("onExecute"), Pi("onEscape"), Hi("onOpenMenu"), Hi("onOpenSubmenu"), zi("onRepositionMenu"), zi("onCollapseMenu"), ws("highlightOnOpen", Gh.HighlightMenuAndItem), ds("data", [ss("primary"), ss("menus"), ss("expansions")]), ws("fakeFocus", !1), zi("onHighlightItem"), zi("onDehighlightItem"), zi("onHover"), Ri(), ss("dom"), ws("navigateOnHover", !0), ws("stayInDom", !1), Su("tmenuBehaviours", [Yp, Zm, Em, nh]), ws("eventOrder", {})],
        apis: {
            collapseMenu: (e, t) => {
                e.collapseMenu(t)
            }
        ...
        factory: (e, t) => {
            const o = ac()
              ...
              , i = (t, o) => {
                a(t, o),
                Zm.getHighlighted(o).orThunk(( () => Zm.getFirst(o))).each((n => {
            ...
            const g = (t, o, r=m.HighlightSubmenu) => {
                if (o.hasConfigured(Um) && Um.isDisabled(o))
                    return A.some(o);
                {
                    const a = s(o);
                    ...
                    A.from(s[0]).bind((a => n.lookupMenu(a).bind((i => {
                        ...
                        return wt(l.element) || nh.append(t, ui(l)),
                        e.onOpenSubmenu(t, o, l, K(s)),
                        r === m.HighlightSubmenu ? (Zm.highlightFirst(l),
                        u(t, n, s)) : (Zm.dehighlightAll(l),
                        A.some(o))
                    }
                    )))))))
                }
              ...
              , h = t => (o, n) => Si(n.getSource(), `.${e.markers.item}`).bind((e => o.getSystem().getByDom(e).toOptional().bind((e => t(o, e).map(E)))))
              , f = Pr([jr(Lh(), ( (e, t) => {
                const o = t.event.item;
            ...
            return {
                ...
                dom: e.dom,
                markers: e.markers,
                behaviours: Cu(e.tmenuBehaviours, [Yp.config({
                    mode: "special",
      ...
      , Yh = km({
        name: "InlineView",
        configFields: [ss("lazySink"), zi("onShow"), zi("onHide"), vs("onEscape"), Su("inlineBehaviours", [tu, wu, Nl]), xs("fireDismissalEventInstead", [ws("event", _r())]), xs("fireRepositionEventInstead", [ws("event", Tr())]), ws("getRelated", A.none), ws("isExtraPart", T), ws("eventOrder", A.none)],
        factory: (e, t) => {
            const o = (t, o, n, s) => {
                const r = e.lazySink(t).getOrDie();
                tu.openWhileCloaked(t, o, ( () => Ad.positionWithinBounds(r, t, n, s()))),
                wu.setValue(t, A.some({
                    mode: "position",
                    config: n,
                    getBounds: s
                }))
              ...
              , s = t => {
                tu.isOpen(t) && wu.getValue(t).each((o => {
                    switch (o.mode) {
                    case "menu":
              ...
              , r = {
                ...
                hide: e => {
                    tu.isOpen(e) && (wu.setValue(e, A.none()),
                    tu.close(e))
                }
                ,
            ...
            return {
                uid: e.uid,
                dom: e.dom,
                behaviours: Cu(e.inlineBehaviours, [tu.config({
    ...
    const Kh = km({
        ...
        factory: e => {
            ...
            return {
                ...
                components: e.components,
                events: t,
                behaviours: _u(e.buttonBehaviours, [ch.config({}), Yp.config({
                    mode: "execution",
                    useSpace: !0,
                    useEnter: !0
                })]),
    ...
    const _f = sf(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"])
      , Tf = sf(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform", "circle", "clippath", "defs", "desc", "ellipse", "filter", "font", "g", "glyph", "glyphref", "hkern", "image", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref", "tspan", "view", "vkern"])
      , Ef = sf(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence"])
      , Af = sf(["animate", "color-profile", "cursor", "discard", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "foreignobject", "hatch", "hatchpath", "mesh", "meshgradient", "meshpatch", "meshrow", "missing-glyph", "script", "set", "solidcolor", "unknown", "use"])
      , Mf = sf(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover", "mprescripts"])
      , Df = sf(["maction", "maligngroup", "malignmark", "mlongdiv", "mscarries", "mscarry", "msgroup", "mstack", "msline", "msrow", "semantics", "annotation", "annotation-xml", "mprescripts", "none"])
      , Bf = sf(["#text"])
      , If = sf(["accept", "action", "align", "alt", "autocapitalize", "autocomplete", "autopictureinpicture", "autoplay", "background", "bgcolor", "border", "capture", "cellpadding", "cellspacing", "checked", "cite", "class", "clear", "color", "cols", "colspan", "controls", "controlslist", "coords", "crossorigin", "datetime", "decoding", "default", "dir", "disabled", "disablepictureinpicture", "disableremoteplayback", "download", "draggable", "enctype", "enterkeyhint", "face", "for", "headers", "height", "hidden", "high", "href", "hreflang", "id", "inputmode", "integrity", "ismap", "kind", "label", "lang", "list", "loading", "loop", "low", "max", "maxlength", "media", "method", "min", "minlength", "multiple", "muted", "name", "nonce", "noshade", "novalidate", "nowrap", "open", "optimum", "pattern", "placeholder", "playsinline", "poster", "preload", "pubdate", "radiogroup", "readonly", "rel", "required", "rev", "reversed", "role", "rows", "rowspan", "spellcheck", "scope", "selected", "shape", "size", "sizes", "span", "srclang", "start", "src", "srcset", "step", "style", "summary", "tabindex", "title", "translate", "type", "usemap", "valign", "value", "width", "xmlns", "slot"])
      ...
      , Rf = sf(["accent", "accentunder", "align", "bevelled", "close", "columnsalign", "columnlines", "columnspan", "denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id", "largeop", "length", "linethickness", "lspace", "lquote", "mathbackground", "mathcolor", "mathsize", "mathvariant", "maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing", "rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator", "separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"])
    ...
    var Yf = function e() {
        ...
        let H = Object.seal(Object.create(null, {
          ...
          , se = {}
          , re = null;
        const ae = kf({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
        let ie = null;
        ...
        const Se = r.createElement("form")
          ...
          , Ce = function(e) {
            if (!we || we !== e) {
                ...
                kf(z, Ff),
                kf(z, Nf)),
                !0 === se.svgFilters && (kf(N, Ef),
                kf(z, Ff),
                kf(z, Nf)),
                !0 === se.mathMl && (kf(N, Mf),
                kf(z, Rf),
                kf(z, Nf))),
                e.ADD_TAGS && (N === L && (N = Cf(N)),
                kf(N, e.ADD_TAGS, xe)),
                e.ADD_ATTR && (z === V && (z = Cf(z)),
                kf(z, e.ADD_ATTR, xe)),
                e.ADD_URI_SAFE_ATTR && kf(ce, e.ADD_URI_SAFE_ATTR, xe),
                e.FORBID_CONTENTS && (re === ae && (re = Cf(re)),
                kf(re, e.FORBID_CONTENTS, xe)),
                oe && (N["#text"] = !0),
        ...
        const Me = function(e) {
          ...
          , Be = function(e) {
            ...
            return e && o && s.insertBefore(r.createTextNode(o), s.childNodes[0] || null),
          ...
          , Ne = function(e) {
            let t;
            if (Re("beforeSanitizeElements", e, null),
            (n = e)instanceof m && ("string" != typeof n.nodeName || "string" != typeof n.textContent || "function" != typeof n.removeChild || !(n.attributes instanceof u) || "function" != typeof n.removeAttribute || "function" != typeof n.setAttribute || "string" != typeof n.namespaceURI || "function" != typeof n.insertBefore || "function" != typeof n.hasChildNodes))
                return Me(e),
                !0;
            var n;
            ...
            e.hasChildNodes() && !Fe(e.firstElementChild) && (!Fe(e.content) || !Fe(e.content.firstElementChild)) && yf(/<[/\w]/g, e.innerHTML) && yf(/<[/\w]/g, e.textContent))
                return Me(e),
                !0;
            if (!N[s] || P[s]) {
                if (!P[s] && ze(s)) {
            ...
            !0) : "noscript" !== s && "noembed" !== s && "noframes" !== s || !yf(/<\/no(script|embed|frames)/i, e.innerHTML) ? (q && 3 === e.nodeType && (t = e.textContent,
            t = ff(t, E, " "),
            t = ff(t, A, " "),
            t = ff(t, M, " "),
          ...
          , Le = function(e, t, o) {
            ...
            if (j && !U[t] && yf(D, t))
                ...
                if (!(ze(e) && (H.tagNameCheck instanceof RegExp && yf(H.tagNameCheck, e) || H.tagNameCheck instanceof Function && H.tagNameCheck(e)) && (H.attributeNameCheck instanceof RegExp && yf(H.attributeNameCheck, t) || H.attributeNameCheck instanceof Function && H.attributeNameCheck(t)) || "is" === t && H.allowCustomizedBuiltInElements && (H.tagNameCheck instanceof RegExp && yf(H.tagNameCheck, o) || H.tagNameCheck instanceof Function && H.tagNameCheck(o))))
                    return !1
            } else if (ce[t])
                ;
            else if (yf(R, ff(o, F, "")))
          ...
          , He = function e(t) {
            ...
            for (Re("beforeSanitizeShadowDOM", t, null); o = n.nextNode(); )
                ...
                Ne(o) || (o.content instanceof a && e(o.content),
                Ve(o));
        ...
        return o.sanitize = function(e) {
            ...
            const d = Ie(ne ? e : t);
            for (; r = d.nextNode(); )
                Ne(r) || (r.content instanceof a && He(r.content),
                Ve(r));
            if (ne)
                return e;
            if (J) {
                if (Z)
                    ...
                    i = t;
                return (z.shadowroot || z.shadowrootmode) && (i = _.call(n, i, !0)),
                i
            }
            let u = Y ? t.outerHTML : t.innerHTML;
            return Y && N["!doctype"] && t.ownerDocument && t.ownerDocument.doctype && t.ownerDocument.doctype.name && yf(Gf, t.ownerDocument.doctype.name) && (u = "<!DOCTYPE " + t.ownerDocument.doctype.name + ">\n" + u),
            q && (u = ff(u, E, " "),
            u = ff(u, A, " "),
            u = ff(u, M, " ")),
      ...
      , ib = km({
        ...
        factory: e => {
            ...
            return {
                ...
                behaviours: Ml([ch.config({}), sh("notification-events", [jr(Ks(), (e => {
    ...
    var lb, cb, db = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), ub = tinymce.util.Tools.resolve("tinymce.EditorManager"), mb = tinymce.util.Tools.resolve("tinymce.Env");
    !function(e) {
        e.default = "wrap",
        e.floating = "floating",
        e.sliding = "sliding",
    ...
    const yv = "tox-menu-nav__js"
      ...
      , Lv = x([gs("data"), ws("inputAttributes", {}), ws("inputStyles", {}), ws("tag", "input"), ws("inputClasses", []), zi("onSetValue"), ws("styles", {}), ws("eventOrder", {}), Su("inputBehaviours", [wu, ch]), ws("selectOnFocus", !0)])
      , zv = e => Ml([ch.config({
      ...
      , Vv = e => ({
        ...zv(e),
        ...Cu(e.inputBehaviours, [wu.config({
            store: {
                mode: "manual",
                ...e.data.map((e => ({
                    initialValue: e
      ...
      , Yv = e => {
        ...
        return {
            ...
            components: [Pv.sketch({
                ...
                inputBehaviours: Ml([sh(n, [jr(er(), (e => {
                    Rr(e, Uv)
                }
                )), jr(Zs(), ( (e, t) => {
      ...
      , Qv = (e, t, o) => zh.parts.items({
        preprocess: n => {
            const s = V(n, o);
            return "auto" !== e && e > 1 ? Jv({
                tag: "div",
                classes: ["tox-collection__group"]
            }, e)(s) : Zv(s, ( (e, o) => "separator" === t[o].type))
        }
    })
      , ey = (e, t, o=!0) => ({
        dom: {
    ...
    A.none())
      ...
      , sy = (e, t, o, n, s) => {
        ...
        if ("normal" === s.menuType || "searchable" === s.menuType) {
            const t = "searchable" !== s.menuType ? ey(n, o) : "search-with-field" === s.searchMode.searchMode ? ( (e, t, o) => {
                ...
                return {
                    ...
                    components: [Yv({
                        ...
                        dom: {
                            tag: "div",
                            classes: [...1 === e ? ["tox-collection--list"] : ["tox-collection--grid"], Xv],
                            attributes: {
                                id: n
                            }
                        },
      ...
      , My = Ts("onAction", b)
      , Dy = e => Cs("type", e)
      , By = e => ts("name", "name", xn(( () => da(`${e}-name`))), Pn)
      , Iy = In([ry, vy])
      ...
      , $y = Qn("type", {
        ...
        contextformtogglebutton: Wy
    })
      , qy = In([Dy("contextform"), Ts("initValue", x("")), wy, ms("commands", $y), ps("launch", Qn("type", {
        contextformbutton: jy,
        contextformtogglebutton: Gy
    }))].concat(Py))
      ...
      , tx = [_y, vy, Sy, ("menuitem",
    ts("value", "value", xn(( () => da("menuitem-value"))), zn())), Ay];
    ...
    var yx = Object.freeze({
        ...
        events: (e, t) => {
            ...
            return Pr(q([[jr(px, (o => {
                ...
                case "children-normal":
                    return [jr(Ks(), ( (o, n) => {
                        Ul(o.element).each((r => {
                            Je(n.event.target, "[data-mce-tooltip]") && t.getTooltip().fold(( () => {
                                Rr(o, bx)
                            }
                            ), (n => {
                                t.isShowing() && (e.onShow(o, n),
                                s(o))
                            }
                            ))
                        }
      ...
      , wx = [ss("lazySink"), ss("tooltipDom"), ws("exclusive", !0), ws("tooltipComponents", []), Ts("delayForShow", x(300)), Ts("delayForHide", x(300)), Os("mode", "normal", ["normal", "follow-highlight", "children-keyboard-focus", "children-normal"]), ws("anchor", (e => ({
        type: "hotspot",
        hotspot: e,
        layouts: {
    ...
    const _x = (e, t) => {
      ...
      , Rx = (e, t) => ta(( (o, n) => {
        Bx(e, o)(e.onAction),
        e.triggersSubmenu || t !== vv.CLOSE_ON_EXECUTE || (o.getSystem().isConnected() && Rr(o, br()),
        n.stop())
    }
    ))
      , Nx = {
      ...
      , zx = (e, t, o, n) => {
        ...
        return {
            ...
            itemBehaviours: Ml([sh("item-events", [Rx(e, o), Ix(e, s), Fx(e, s)]), (r = () => !e.enabled || n.isDisabled(),
            Um.config({
                disabled: r,
                disableClass: "tox-collection__item--state-disabled"
            })), Ex(), nh.config({})].concat(e.itemBehaviours))
        };
        var r
    }
      , Vx = e => ({
      ...
      , Yx = (e, t, o, n=A.none()) => "color" === e.presets ? ( (e, t, o) => {
        const n = e.value
        ...
        const s = {
          ...
          , r = o ? e.iconContent.map((e => rb(e, s, t.icons, n))).orThunk(( () => A.some({
            dom: s
        }))) : A.none()
          , a = e.checkMark
          , i = A.from(e.meta).fold(( () => Ux), (e => ve(e, "style") ? k(jx, e.style) : Ux))
          , l = e.htmlContent.fold(( () => e.textContent.map(i)), (e => A.some(Wx(e, [Ov]))));
        return {
            dom: qx(e.ariaLabel),
      ...
      , Xx = (e, t, o) => be(e, "tooltipWorker").map((e => [kx.config({
        lazySink: t.getSink,
        tooltipDom: {
            tag: "div",
        ...
        onShow: (t, o) => {
            e((e => {
                kx.setComponents(t, [ii({
                    element: ze(e)
                })])
            }
            ))
        }
    })])).getOrThunk(( () => o.map((e => [kx.config({
      ...
      , fw = e => {
        if ("transparent" === e)
            return A.some(uw(0, 0, 0, 0));
        const t = cw.exec(e);
        if (null !== t)
            return A.some(hw(t[1], t[2], t[3], "1"));
        const o = dw.exec(e);
    ...
    const Aw = {}
      ...
      , Rw = e => {
        ...
        ow(t) ? A.some({
            value: nw(t)
        }) : A.none()).orThunk(( () => fw(e).map(rw))).getOrThunk(( () => {
      ...
      , Hw = "#000000"
      , Pw = (e, t) => t === Nw && e.options.isSet("color_map_foreground") ? Vw("color_map_foreground")(e) : t === Lw && e.options.isSet("color_map_background") ? Vw("color_map_background")(e) : Vw("color_map")(e)
        ...
        const o = ze(e.selection.getStart())
          , n = "hilitecolor" === t ? Ns(o, (e => {
            if ($e(e)) {
                ...
                return Ce(fw(t).exists((e => 0 !== e.alpha)), t)
            }
            return A.none()
        }
        )).getOr("rgba(0, 0, 0, 0)") : Nt(o, "color");
      ...
      , Kw = (e, t, o, n) => {
        ...
        ), Yw(e, t).getOr(Hw)) : "remove" === o ? (n(""),
        e.execCommand("mceRemoveTextcolor", t)) : (n(o),
        e.execCommand("mceApplyTextcolor", t, o))
    }
      , Jw = (e, t, o) => e.concat((e => V(Mw(e).state(), (e => ({
        type: "choiceitem",
        text: e,
        icon: "checkmark",
        value: e
      ...
      , nS = (e, t, o, n) => {
        e.ui.registry.addSplitButton(t, {
            ...
            onSetup: s => {
                Qw(s, t, n.get());
                const r = n => {
                    n.name === t && (Qw(s, n.name, n.color),
                    eS(s, oS(e, o, n.color)))
                }
                ;
                return e.on("TextColorChange", r),
                Sw(kw(e)(s), ( () => {
      ...
      , iS = (e, t, o, n, s, r, a) => we(V(e, (i => {
        return "choiceitem" === i.type ? (l = i,
        Xn("choicemenuitem", nx, l)).fold(oy, (i => A.some(( (e, t, o, n, s, r, a, i=!0) => {
            const l = Yx({
                presets: o,
              ...
              , c = e.text.filter(x(!t)).map((e => kx.config(a.tooltips.getConfig({
        ...
        )(i, 1 === o, n, t, r(i.value), s, a, ty(e))))) : A.none();
        var l
    }
    )))
      , lS = (e, t) => {
      ...
      , uS = (e, t, o) => {
        ...
        return di({
            ...
            behaviours: Ml([sh("insert-table-picker-cell", [jr(Xs(), ch.focus), jr(gr(), n), jr(or(), s), jr(hr(), s)]), bh.config({
      ...
      , pS = {
        inserttable: (e, t) => {
            ...
            return {
                ...
                autofocus: !0,
                components: [Zx.widget({
                    dom: {
                        tag: "div",
                        classes: ["tox-insert-table-picker"]
                    },
                    components: mS(n).concat(r.asSpec()),
                    behaviours: Ml([sh("insert-table-picker", [Zr((e => {
                        nh.set(r.get(e), [s])
                    }
                    )), Yr(cS, ( (e, t, o) => {
        ...
        colorswatch: (e, t) => {
            const o = ( (e, t) => {
                ...
                return e.initData.colors.fold(( () => Jw(t.colorinput.getColors(e.initData.storageKey), e.initData.storageKey, o)), (e => e.concat(Xw(o))))
            }
            )(e, t)
              , n = t.colorinput.getColorCols(e.initData.storageKey)
              , s = "color"
              , r = {
                ...aS(da("menu-value"), o, (t => {
                    e.onAction({
                        value: t
                    })
                }
                ), n, s, vv.CLOSE_ON_EXECUTE, e.select.getOr(T), t.shared.providers),
                markers: Iv(s),
                movement: lS(n, s)
            };
            return {
      ...
      , hS = e => ({
        ...
        dom: {
            tag: "div",
            classes: [xv, "tox-collection__group-heading"]
        },
    ...
    const yS = Bl({
      ...
      , AS = (e, t, o, n, s, r, a) => {
        const i = ( (e, t, o, n, s, r, a) => {
            ...
            e.fetch)(o).map(t))(e, t, n)
              , l = BS(n, e);
            return i.map((e => e.bind((e => A.from(qh.sketch({
                ...r.menu(),
                uid: ba(""),
                data: e,
                highlightOnOpen: a,
      ...
      , MS = (e, t, o, n, s, r, a) => (tu.close(n),
    OS(n))
      , DS = (e, t, o, n, s, r) => {
        const a = yS.getCoupled(o, "sandbox");
        return (tu.isOpen(a) ? MS : AS)(e, t, o, a, n, s, r)
    }
      , BS = (e, t) => e.getSystem().getByUid(t.uid + "-" + _S()).map((e => () => an.value(e))).getOrThunk(( () => t.lazySink.fold(( () => () => an.error(new Error("No internal sink is specified, nor could an external sink be found"))), (t => () => t(e)))))
      , IS = e => {
      ...
      , FS = (e, t, o) => {
        ...
        return {
            ...
            behaviours: _u(e.sandboxBehaviours, [wu.config({
                store: {
                    mode: "memory",
                    initialValue: t
                }
                ...
                onOpen: (s, r) => {
                    ...
                    e.matchWidth && ( (e, t, o) => {
                        const n = Em.getCurrent(t).getOr(t)
                          , s = Qt(e.element);
                        o ? It(n.element, "min-width", s + "px") : ( (e, t) => {
                            Zt.set(e, t)
                        }
                        )(n.element, s)
                    }
      ...
      , LS = x([ss("dom"), ss("fetch"), zi("onOpen"), Vi("onExecute"), ws("getHotspot", A.some), ws("getAnchorOverrides", x({})), Ec(), Su("dropdownBehaviours", [bh, yS, Yp, ch]), ss("toggleClass"), ws("eventOrder", {}), gs("lazySink"), ws("matchWidth", !1), ws("useMinWidth", !1), gs("role")].concat(NS()))
      , zS = x([Ku({
        ...
        factory: (e, t, o, n) => {
            const s = e => {
              ...
              , a = {
                ...
                ,
                refetch: t => yS.getExistingCoupled(t, "sandbox").fold(( () => r(t, b, Gh.HighlightMenuAndItem).map(b)), (o => AS(e, w, t, o, n, b, Gh.HighlightMenuAndItem).map(b))),
                isOpen: bh.isOn,
                close: e => {
                    bh.isOn(e) && r(e, b, Gh.HighlightMenuAndItem).get(b)
                }
            ...
            return {
                ...
                dom: e.dom,
                components: t,
                behaviours: Cu(e.dropdownBehaviours, [bh.config({
                    ...
                    ,
                    onEscape: (e, t) => VS.isOpen(e) ? (VS.close(e),
                    A.some(!0)) : A.none()
                }), ch.config({})]),
                events: yh(A.some((e => {
      ...
      , US = e => yS.getExistingCoupled(e, "sandbox").bind(Gv).map(qv).map((e => e.fetchPattern)).getOr("");
    var WS;
    !function(e) {
    ...
    const jS = (e, t, o, n, s) => {
        ...
        case "menuitem":
            return (i = e,
            Xn("menuitem", lx, i)).fold(oy, (e => A.some(( (e, t, o, n=!0) => {
                const s = Yx({
                    presets: "normal",
                    iconContent: e.icon,
                    textContent: e.text,
        ...
        case "nestedmenuitem":
            return (e => Xn("nestedmenuitem", cx, e))(e).fold(oy, (e => A.some(( (e, t, o, n=!0, s=!1) => {
                const r = s ? (a = o.icons,
                Px("chevron-down", a, [_v])) : (e => Px("chevron-right", e, [_v]))(o.icons);
                var a;
                const i = Yx({
                    presets: "normal",
                    iconContent: e.icon,
        ...
        case "togglemenuitem":
            return (e => Xn("togglemenuitem", dx, e))(e).fold(oy, (e => A.some(( (e, t, o, n=!0) => {
                const s = Yx({
                    iconContent: e.icon,
                    textContent: e.text,
                    htmlContent: A.none(),
      ...
      , GS = (e, t, o, n, s, r, a) => {
        ...
        return we(V(e, (e => {
            ...
            case "separator":
                return (n = e,
                Xn("Autocompleter.Separator", Iy, n)).fold(oy, (e => A.some(hS(e))));
            case "cardmenuitem":
                return (e => Xn("cardmenuitem", ox, e))(e).fold(oy, (e => A.some(( (e, t, o, n) => {
                    const s = {
                        dom: qx(e.label),
            ...
            default:
                return (e => Xn("Autocompleter.Item", Fy, e))(e).fold(oy, (e => A.some(( (e, t, o, n, s, r, a, i=!0) => {
                    const l = Yx({
                        presets: n,
                        textContent: A.none(),
      ...
      , XS = (e, t) => {
        const o = da("autocompleter")
          ...
          , a = di(Yh.sketch({
            ...
            inlineBehaviours: Ml([sh("dismissAutocompleter", [jr(_r(), ( () => u())), jr(Ir(), ( (t, o) => {
          ...
          , c = () => {
            if (i()) {
                ...
                Et(t, "aria-owns").filter((e => e === o)).each(( () => {
                    Mt(t, "aria-owns"),
                    Mt(t, "aria-activedescendant")
                }
                ))
            }
        }
          ...
          , m = s => {
            const i = (o => {
                ...
                return Y(o, (o => {
                    ...
                    ), s, vv.BUBBLE_TO_SANDBOX, t, o.highlightOn)
                }
                ))
            }
            )(s);
            i.length > 0 ? (( (t, o) => {
                ...
                Yh.showMenuAt(a, {
                    ...
                    return {
                        data: qS({
                            ...e,
                            movement: s,
                            menuBehaviours: mx("auto" !== t ? [] : [Zr(( (e, t) => {
                ...
                )(sy("autocompleter-value", !0, o, n, {
                    menuType: "normal"
                }), n, WS.ContentFocus, "normal")),
        ...
        ( (e, t) => {
            ...
            t.on("keydown", (t => {
                const s = t.which;
                e.isActive() && (e.isMenuOpen() ? 13 === s ? (n().each(Lr),
      ...
      , QS = (e, t) => pv(e) ? (e => {
        const t = ed(e, ZS)
          , o = 0 === t.length ? yt(e).map(xt).map((e => ed(e, ZS))).getOr([]) : t;
        return oe(o).map((e => ({
            element: e,
            others: o.slice(1)
        })))
      ...
      , sk = (e, t) => {
        const o = {
          ...
          , n = (e => {
            const t = ac()
              ...
              , s = Is([{
                ...
                key: Ws(),
                value: s => (n.cancel(),
                t.get().filter((e => et(e.target, s.target))).map((t => o.get() ? (s.prevent(),
                !1) : e.triggerEvent(hr(), s))))
            }]);
            return {
          ...
          , s = V(["touchstart", "touchmove", "touchend", "touchcancel", "gesturestart", "mousedown", "mouseup", "mouseover", "mousemove", "mouseout", "click"].concat(["selectstart", "input", "contextmenu", "change", "transitionend", "transitioncancel", "drag", "dragstart", "dragend", "dragenter", "dragleave", "dragover", "drop", "keyup"]), (t => lc(e, t, (e => {
          ...
          , i = lc(e, "keydown", (e => {
            o.triggerEvent("keydown", e) ? e.kill() : o.stopBackspace && (e => e.raw.which === Qm[0] && !R(["input", "textarea"], We(e.target)) && !tk(e.target, '[contenteditable="true"]'))(e) && e.prevent()
        }
        ))
          , l = lc(e, "focusin", (e => {
      ...
      , ik = (e, t, o, n, s, r) => {
        ...
        ak.complete())), (e => {
            ...
            ak.stopped()) : i.isCut() ? (r.logEventCut(t, e.element, o.purpose),
            ak.complete()) : at(e.element).fold(( () => (r.logNoParent(t, e.element, o.purpose),
            ak.complete())), (n => (r.logEventResponse(t, e.element, o.purpose),
            ak.resume(n))))
        }
        ))
    }
      ...
      , dk = () => {
        const e = ( () => {
            ...
            return {
                ...
                find: (t, o, n) => be(e, o).bind((e => Ns(n, (t => ( (e, t) => fa(t).bind((t => be(e, t))).map((e => ( (e, t) => ({
                    element: e,
                    descHandler: t
                }))(t, e))))(e, t)), t)))
            }
        ...
        return {
            ...
            register: n => {
                ...
                ye(t, s) && ( (e, n) => {
                    const s = t[n];
                    if (s !== e)
                        throw new Error('The tagId "' + n + '" is already used by: ' + ra(s.element) + "\nCannot use it for: " + ra(e.element) + "\nThe conflicting element is" + (wt(s.element) ? " " : " not ") + "already in the DOM");
                    o(e)
                }
                )(n, s);
                const r = [n];
      ...
      , mk = e => {
        const t = t => at(e.element).fold(E, (e => et(t, e)))
          ...
          , n = (e, n) => o.find(t, e, n)
          , s = sk(e.element, {
            triggerEvent: (e, t) => Ai(e, t.target, (o => ( (e, t, o, n) => ck(e, t, o, o.target, n))(n, e, t, o)))
        })
          , r = {
            debugInfo: x("real"),
            triggerEvent: (e, t, o) => {
          ...
          , a = e => {
            e.connect(r),
            qe(e.element) || (o.register(e),
            H(e.components(), a),
            r.triggerEvent(yr(), e.element, {
                target: e.element
            }))
        }
          , i = e => {
            qe(e.element) || (H(e.components(), i),
            o.unregister(e)),
            e.disconnect()
        }
          , l = t => {
      ...
      , hk = Cm({
        ...
        partFields: pk(),
        factory: (e, t, o, n) => {
            const s = Cu(e.fieldBehaviours, [Em.config({
                find: t => cm(t, e, "field")
            }), wu.config({
                store: {
                    mode: "manual",
    ...
    const xk = (e, t, o, n) => {
                ...
                onSetValue: (o, n) => {
                    ( (o, n) => {
                        const r = V(n, (o => {
                            ...
                            return `<div data-mce-tooltip="${l}" class="tox-collection__item${t.isDisabled() ? " tox-collection__item--state-disabled" : ""}" tabindex="-1" data-collection-item-value="${yk.encodeAllRaw(o.value)}" aria-label="${l}">${a}${r}</div>`
                        }
                        ))
                    ...
                    "auto" === e.columns && ux(o, 5, "tox-collection__item").each(( ({numRows: e, numColumns: t}) => {
                        Yp.setGridSize(o, e, t)
                    }
                    )),
                    Rr(o, Bk)
                }
            }), vk.config({}), Yp.config((d = e.columns,
            "normal",
            1 === d ? {
                mode: "menu",
                moveOnTab: !1,
      ...
      , zk = (e, t, o) => t.validator.fold(( () => OS(an.value(!0))), (t => t.validate(e)))
      , Vk = (e, t, o) => (t.notify.each((t => {
        t.onValidate(e)
    }
    )),
    zk(e, t).map((o => e.getSystem().isConnected() ? o.fold((o => (Lk(e, t, 0, o),
    an.error(o))), (o => (Nk(e, t),
    an.value(o)))) : an.error("No longer in system"))));
    var Hk = Object.freeze({
      ...
      , Uk = [ss("invalidClass"), ws("getRoot", A.none), xs("notify", [ws("aria", "alert"), ws("getContainer", A.none), ws("validHtml", ""), zi("onValid"), zi("onInvalid"), zi("onValidate")]), xs("validator", [ss("validate"), ws("onEvent", "input"), ws("validateOnLoad", !0)])];
    const Wk = Bl({
        fields: Uk,
        name: "invalidating",
        active: Pk,
      ...
      , Xk = e => Ju({
        ...
        overrides: t => t.model.manager.edgeActions[e].fold(( () => ({})), (e => ({
            events: Pr([Gr(Ps(), ( (t, o, n) => e(t, n)), [t]), Gr(Gs(), ( (t, o, n) => e(t, n)), [t]), Gr($s(), ( (t, o, n) => {
      ...
      , sC = Xu({
        ...
        overrides: e => ({
            events: Pr([qr(Ps(), e, "spectrum"), qr(Us(), e, "spectrum"), qr(Ws(), e, "spectrum"), qr(Gs(), e, "spectrum"), qr($s(), e, "spectrum"), qr(Ys(), e, "spectrum")])
        })
    })
      , rC = e => pg(e.event);
    var aC = [Yk, nC, Qk, Jk, tC, Kk, Zk, oC, eC, sC, Xu({
        ...
        overrides: e => {
            ...
            return {
                ...
                events: Pr([jr(Ps(), o), jr(Us(), o), jr(Gs(), o), jr($s(), ( (t, n) => {
    ...
    var EO = Object.freeze({
        ...
        setPositionFromValue: (e, t, o, n) => {
            const s = DC(o)
              ...
              , i = Qt(t.element) / 2
              , l = Gt(t.element) / 2;
            It(t.element, "left", r - i + "px"),
            It(t.element, "top", a - l + "px")
        }
        ,
        onLeft: kO,
        onRight: CO,
    ...
    const AO = Cm({
        name: "Slider",
        configFields: [ws("stepSize", 1), ws("speedMultiplier", 10), ws("onChange", b), ws("onChoose", b), ws("onInit", b), ws("onDragStart", b), ws("onDragEnd", b), ws("snapToGrid", !1), ws("rounded", !0), gs("snapStart"), rs("model", Qn("mode", {
            ...
            xy: [ws("minX", 0), ws("maxX", 100), ws("minY", 0), ws("maxY", 100), os("value", (e => Ms({
                x: e.mode.minX,
                y: e.mode.minY
            }))), ss("getInitialValue"), Ui("manager", EO)]
        })), Su("sliderBehaviours", [Yp, wu]), os("mouseIsDown", ( () => Ms(!1)))],
        partFields: aC,
        factory: (e, t, o, n) => {
            ...
            return {
                ...
                dom: e.dom,
                components: t,
                behaviours: Cu(e.sliderBehaviours, [Yp.config({
                    mode: "special",
                    focusIn: b
                }), wu.config({
                    store: {
      ...
      , NO = (e, t) => ({
        ...
        dom: e.dom,
        components: t,
        behaviours: Cu(e.formBehaviours, [wu.config({
            store: {
                mode: "manual",
                getValue: t => {
                    const o = mm(t, e);
                    return ce(o, ( (e, t) => e().bind((e => {
                        return o = Em.getCurrent(e),
        ...
        apis: {
            getField: (t, o) => cm(t, e, o).bind(Em.getCurrent)
        }
    })
      , LO = {
        ...
        const s = (o, n) => Wk.config({
          ...
          , r = (o, n, r, a, i) => {
            const l = e(PO + "range")
              ...
              , u = [c, d]
              , m = "hex" !== n ? [hk.parts["aria-descriptor"]({
                text: l
            })] : [];
            return {
                dom: {
          ...
          , c = km({
            factory: () => {
                const s = {
                  ...
                  , g = (e, t) => {
                    ...
                    (e => "hex" === e.type)(n) ? ( (e, t) => {
                        ...
                        d(t, A.some(n)),
                        c("red").bind((e => c("green").bind((t => c("blue").map((o => uw(e, t, o, 1))))))).each((t => {
                            const o = ( (e, t) => {
                                const o = rw(t);
                                return LO.getField(e, "hex").each((t => {
                                    ch.isFocused(t) || wu.setValue(e, {
                                        hex: o.value
                                    })
                                }
                                )),
                ...
                return vn(LO.sketch((o => ({
                    ...
                    components: [o.field("red", hk.sketch(r(mw, "red", h.label, h.description, 255))), o.field("green", hk.sketch(r(mw, "green", f.label, f.description, 255))), o.field("blue", hk.sketch(r(mw, "blue", b.label, b.description, 255))), o.field("hex", hk.sketch(r(ow, "hex", v.label, v.description, "ffffff"))), i.asSpec()],
                    formBehaviours: Ml([Wk.config({
        ...
        const o = km({
            ...
            factory: o => {
                ...
                return {
                    ...
                    behaviours: Ml([sh("colour-picker-events", [jr(MO, ( () => {
                        const e = [c, u, m];
                        return (t, o) => {
                            const n = o.event.hex
                              , s = (e => Iw(pw(e)))(n);
      ...
      , XO = (e, t, o) => YO(e, (e => t(e.element)), ( (e, t) => o(e.element, t)))
      , KO = e => wu.config({
        store: {
            mode: "memory",
            initialValue: e
    ...
    const t_ = (e, t) => {
      ...
      , S_ = (e, t, o) => {
        ...
        A.from(n.contentDocument).fold(o, (e => {
            ...
            const s = ( (e, t) => {
                const o = e.body;
                return A.from(!/^<!DOCTYPE (html|HTML)/.test(t) && (!y_ && !f_ || g(o) && (0 !== o.scrollTop || Math.abs(o.scrollHeight - o.clientHeight) > 1)) ? o : e.documentElement)
            }
      ...
      , F_ = (e, t, o, n) => {
        const s = Ms(b)
          ...
          , p = Zh(VS.sketch({
            ...
            ,
            dropdownBehaviours: Ml([...e.dropdownBehaviours, Ax(( () => e.disabled || o.providers.isDisabled())), Ex(), jk.config({}), nh.config({}), ...e.tooltip.map((e => kx.config(o.providers.tooltips.getConfig({
                tooltipText: o.providers.translate(e)
            })))).toArray(), sh(m, [Ix(e, s), Fx(e, s)]), sh(u, [Zr(( (e, t) => T_(e)))]), sh("menubutton-update-display-text", [jr(B_, ( (e, t) => {
            ...
            sandboxBehaviours: Ml([Yp.config({
                mode: "special",
                onLeft: i,
                onRight: i
            }), sh("dropdown-sandbox-events", [jr(Uv, ( (e, t) => {
                (e => {
                    const t = wu.getValue(e)
                      , o = Gv(e).map(qv);
                    VS.refetch(t).get(( () => {
                        const e = yS.getCoupled(t, "sandbox");
                        o.each((t => Gv(e).each((e => ( (e, t) => {
      ...
      , L_ = (e, t) => {
        const o = ( (e, t) => {
            const o = j(e, ( (e, o) => (e => r(e))(o) ? "" === o ? e : "|" === o ? e.length > 0 && !R_(e[e.length - 1]) ? e.concat([N_]) : e : ve(t, o.toLowerCase()) ? e.concat([t[o.toLowerCase()]]) : e : e.concat([o])), []);
            return o.length > 0 && R_(o[o.length - 1]) && o.pop(),
            o
        }
        )(r(e) ? e.split(" ") : e, t);
        return W(o, ( (e, o) => {
      ...
      , V_ = e => !ve(e, "items")
      , H_ = "data-value"
      , P_ = (e, t, o, n) => V(o, (o => V_(o) ? {
        type: "togglemenuitem",
        text: o.text,
        value: o.value,
        active: o.value === n,
        onAction: () => {
            wu.setValue(e, o.value),
            Nr(e, Ck, {
                name: t
            }),
            ch.focus(e)
      ...
      , W_ = km({
        ...
        factory: (e, t) => {
            ...
            return {
                ...
                components: o,
                behaviours: Cu(e.selectBehaviours, [ch.config({}), wu.config({
                    store: {
                        mode: "manual",
                        getValue: e => Ja(e.element),
                        setValue: (t, o) => {
                            const n = oe(e.options);
                            G(e.options, (e => e.value === o)).isSome() ? Za(t.element, o) : -1 === t.element.dom.selectedIndex && "" === o && n.each((e => Za(t.element, e.value)))
                        }
                        ,
                        ...n
                    }
      ...
      , j_ = x([ws("field1Name", "field1"), ws("field2Name", "field2"), Hi("onLockedChange"), Ni(["lockClass"]), ws("locked", !1), Ou("coupledFieldBehaviours", [Em, wu])])
      , G_ = (e, t) => Xu({
        factory: hk,
        name: e,
        overrides: e => ({
            fieldBehaviours: Ml([sh("coupled-input-behaviour", [jr(er(), (o => {
      ...
      , $_ = x([G_("field1", "field2"), G_("field2", "field1"), Xu({
        factory: Kh,
        schema: [ss("dom")],
        name: "lock",
        overrides: e => ({
            buttonBehaviours: Ml([bh.config({
                selected: e.locked,
      ...
      , q_ = Cm({
        ...
        factory: (e, t, o, n) => ({
            ...
            dom: e.dom,
            components: t,
            behaviours: _u(e.coupledFieldBehaviours, [Em.config({
                find: A.some
            }), wu.config({
                store: {
                    mode: "manual",
      ...
      , J_ = (e, t) => {
        const o = e.label.map((e => kk(e, t)))
          ...
          , s = e.validation.map((e => Wk.config({
    ...
    var dT = Object.freeze({
      ...
      , uT = Object.freeze({
        ...
        events: (e, t) => Pr([Jr(sr(), ( (o, n) => {
            n.event.raw.propertyName === e.dimension.property && (tT(o, e),
            t.isExpanded() && Pt(o.element, e.dimension.property),
            (t.isExpanded() ? e.onGrown : e.onShrunk)(o))
        }
        ))])
    })
      , mT = [ss("closedClass"), ss("openClass"), ss("shrinkingClass"), ss("growingClass"), gs("getAnimationRoot"), zi("onShrunk"), zi("onStartShrink"), zi("onGrown"), zi("onStartGrow"), ws("expanded", !1), rs("dimension", Qn("property", {
    ...
    const gT = Bl({
      ...
      , pT = e => ({
        ...
        setActive: t => {
            const o = e.element;
            t ? (ja(o, "tox-tbtn--enabled"),
            Ot(o, "aria-pressed", !0)) : ($a(o, "tox-tbtn--enabled"),
            Mt(o, "aria-pressed"))
        }
        ,
      ...
      , hT = (e, t, o, n, s=!0, r) => F_({
        ...
        fetch: (t, n) => {
            const s = {
                pattern: e.search.isSome() ? US(t) : ""
            };
            e.fetch((t => {
                n(z_(t, vv.CLOSE_ON_EXECUTE, o, {
                    isHorizontalMenu: !1,
                    search: e.search
                }))
            }
      ...
      , yT = ({leaf: e, onLeafAction: t, visible: o, treeId: n, selectedId: s, backstage: r}) => {
        ...
        Kh.sketch({
            ...
            buttonBehaviours: Ml([...o ? [vk.config({})] : [], bh.config({
                ...
                o ? (vi(e.element, ".tox-tree--directory").each((t => {
      ...
      , wT = ({directory: e, visible: t, noChildren: o, backstage: n}) => {
        ...
        return Kh.sketch({
            ...
            buttonBehaviours: Ml([...t ? [vk.config({})] : [], sh(xT, [jr(Zs(), ( (e, t) => {
                const n = "ArrowRight" === t.event.raw.code
                  , s = "ArrowLeft" === t.event.raw.code;
                n && o && t.stop(),
                (n || s) && vi(e.element, ".tox-tree--directory").each((o => {
                    e.getSystem().getByDom(o).each((o => {
                        !bh.isOn(o) && n || bh.isOn(o) && s ? (l(e),
                        t.stop()) : s && !bh.isOn(o) && (vi(o.element, ".tox-tree--directory").each((e => {
      ...
      , ST = ({children: e, onLeafAction: t, visible: o, treeId: n, expandedIds: s, selectedId: r, backstage: a}) => ({
        ...
        components: e.map((e => "leaf" === e.type ? yT({
            leaf: e,
            selectedId: r,
            onLeafAction: t,
            visible: o,
    ...
    var ET = Object.freeze({
      ...
      , AT = [rs("stream", Qn("mode", {
        throttle: [ss("delay"), ws("stopEvent", !0), Ui("streams", {
            setup: (e, t) => {
                const o = e.stream
    ...
    })), ws("event", "input"), gs("cancelEvent"), Hi("onStream")];
    const MT = Bl({
        fields: AT,
        name: "streaming",
        active: _T,
      ...
      , RT = x([gs("lazySink"), ss("fetch"), ws("minChars", 5), ws("responseTime", 1e3), zi("onOpen"), ws("getHotspot", A.some), ws("getAnchorOverrides", x({})), ws("layouts", A.none()), ws("eventOrder", {}), As("model", {}, [ws("getDisplayText", (e => void 0 !== e.meta && void 0 !== e.meta.text ? e.meta.text : e.value)), ws("selectsOver", !0), ws("populateFromBrowse", !0)]), zi("onSetValue"), Vi("onExecute"), zi("onItemExecute"), ws("inputClasses", []), ws("inputAttributes", {}), ws("inputStyles", {}), ws("matchWidth", !0), ws("useMinWidth", !1), ws("dismissOnBlur", !0), Ni(["openClass"]), gs("initialData"), Su("typeaheadBehaviours", [ch, wu, MT, Yp, bh, yS]), os("lazyTypeaheadComp", ( () => Ms(A.none))), os("previewing", ( () => Ms(!0)))].concat(Lv()).concat(NS()))
      , NT = x([Ku({
        schema: [Ri()],
        name: "menu",
        overrides: e => ({
            ...
            onHighlightItem: (t, o, n) => {
                e.previewing.get() ? e.lazyTypeaheadComp.get().each((t => {
                    ( (e, t, o) => {
                        ...
                        e.model.selectsOver ? (Zm.dehighlight(o, n),
            ...
            ,
            onExecute: (t, o) => e.lazyTypeaheadComp.get().map((e => (Nr(e, FT(), {
                item: o
            }),
            !0))),
            onHover: (t, o) => {
        ...
        factory: (e, t, o, n) => {
            const s = (t, o, s) => {
              ...
              , a = e => t => t.map((t => {
                ...
                return wu.getState(e).update(V(n, (e => e.data))),
                t
            }
            ))
              , i = e => Em.getCurrent(e)
              , l = "typeaheadevents"
              , c = [ch.config({}), wu.config({
                onSetValue: e.onSetValue,
                store: {
                    mode: "dataset",
                        ...
                        const r = t => {
                            i(s).each((t => {
                                o.fold(( () => {
                                    ...
                                    Zm.getHighlighted(t).orThunk(( () => (Zm.highlightFirst(t),
                                    A.none())))
                                }
                                ))
                            }
                ...
                mode: "special",
                onDown: (e, t) => (s(e, t, Zm.highlightFirst),
                A.some(!0)),
                onEscape: e => {
                    const t = yS.getCoupled(e, "sandbox");
                    return tu.isOpen(t) ? (tu.close(t),
                    A.some(!0)) : A.none()
                }
                ,
                onUp: (e, t) => (s(e, t, Zm.highlightLast),
                A.some(!0)),
                onEnter: t => {
                    const o = yS.getCoupled(t, "sandbox")
                      , n = tu.isOpen(o);
                    if (n && !e.previewing.get())
                        return i(o).bind((e => Zm.getHighlighted(e))).map((e => (Nr(t, FT(), {
                            item: e
                        }),
                        !0)));
                    {
      ...
      , zT = e => ({
        ...
        bindFuture: t => zT(e.bind((e => e.fold((e => OS(an.error(e))), (e => t(e)))))),
      ...
      , HT = (e, t, o=[], n, s, r, a) => {
        const i = t.fold(( () => ({})), (e => ({
          ...
          , l = {
            buttonBehaviours: Ml([Ax(( () => !e.enabled || a.isDisabled())), Ex(), vk.config({}), ...r.map((e => kx.config(a.tooltips.getConfig({
                tooltipText: a.translate(e)
            })))).toArray(), sh("button press", [Wr("click"), Wr("mousedown")])].concat(o)),
            eventOrder: {
      ...
      , GT = (e, t) => o => {
        "custom" === t ? Nr(o, Tk, {
            name: e,
            value: {}
        }) : "submit" === t ? Rr(o, Ek) : "cancel" === t ? Rr(o, _k) : console.error("Unknown button type: ", t)
    }
      , $T = (e, t, o) => {
        if (( (e, t) => "menu" === t)(0, t)) {
            const t = () => r
      ...
      , QT = e => A.from(e.anchorTop).map((e => XT("<top>", e))).toArray()
      , eE = e => A.from(e.anchorBottom).map((e => XT("<bottom>", e))).toArray()
      , tE = (e, t) => {
        const o = e.toLowerCase();
        return U(t, (e => {
            var t;
      ...
      , sE = e => e.dom.checked
      , rE = e => (t, o, n, s) => be(o, "name").fold(( () => e(o, s, A.none())), (r => t.field(r, e(o, s, be(n, r)))))
      , aE = {
        bar: rE(( (e, t) => ( (e, t) => ({
            dom: {
                tag: "div",
        ...
        label: rE(( (e, t) => ( (e, t) => {
            ...
            return {
                ...
                behaviours: Ml([jO(), nh.config({}), (n = A.none(),
                XO(n, oa, na)), Yp.config({
                    mode: "acyclic"
                })])
            };
            var n
              ...
              , c = hk.parts.field({
                factory: {
                    sketch: e => r_(A.from(r), {
                        ...
                        behaviours: Ml([vk.config({}), ch.config({}), YO(o, i.getValue, i.setValue), Nl.config({
                            channels: {
                                [p_]: {
                                    onReceive: (e, t) => {
                                        t.newFocus.each((t => {
        ...
        checkbox: rE(( (e, t, o) => ( (e, t, o) => {
            ...
            A.some(!0))
              , s = hk.parts.field({
                ...
                }), vk.config({}), ch.config({}), XO(o, sE, nE), Yp.config({
                    mode: "special",
                    onEnter: n,
                    onSpace: n,
                    stopSpaceKeyup: !0
                }), sh("checkbox-events", [jr(tr(), ( (t, o) => {
                    Nr(t, Ck, {
                        name: e.name
                    })
                }
              ...
              , a = e => rb("checked" === e ? "selected" : "unselected", {
                tag: "span",
            ...
            return hk.sketch({
                ...
                fieldBehaviours: Ml([Um.config({
                    disabled: () => !e.enabled || t.isDisabled()
                }), Ex()])
            })
        }
        )(e, t.shared.providers, o))),
        colorinput: rE(( (e, t, o) => ( (e, t, o, n) => {
            const s = hk.parts.field({
                factory: Pv,
                inputClasses: ["tox-textfield"],
                data: n,
                onSetValue: e => Wk.run(e).get(b),
                inputBehaviours: Ml([Um.config({
                    disabled: t.providers.isDisabled
                }), Ex(), vk.config({}), Wk.config({
                    ...
                    validator: {
                        ...
                        validate: e => {
                            const t = wu.getValue(e);
                            if (0 === t.length)
                                return OS(an.value(!0));
                            {
                                const e = Ne("span");
                                It(e, "background-color", t);
                                const o = zt(e, "background-color").fold(( () => an.error("blah")), (e => an.value(t)));
                                return OS(o)
                            }
                        }
                    }
              ...
              , i = Zh(( (e, t) => VS.sketch({
                ...
                lazySink: t.getSink,
                fetch: o => CS((t => e.fetch(t))).map((n => A.from(qS(vn(aS(da("menu-value"), n, (t => {
                    e.onItemAction(o, t)
                }
                ), e.columns, e.presets, vv.CLOSE_ON_EXECUTE, T, t.providers), {
                    movement: lS(e.columns, e.presets)
                }))))),
                parts: {
                    menu: Nv(0, 0, e.presets)
                }
            }))({
                dom: {
                    tag: "span",
            ...
            return hk.sketch({
                ...
                fieldBehaviours: Ml([sh("form-field-events", [jr(Gk, ( (t, o) => {
                    i.getOpt(t).each((e => {
        ...
        colorpicker: rE(( (e, t, o) => ( (e, t, o) => {
            const n = e => "tox-" + e
              , s = WO((e => t => r(t) ? e.translate(JO[t]) : e.translate(t))(t), n)
              , a = Zh(s.sketch({
                dom: {
                    tag: "div",
            ...
            return {
                ...
                components: [a.asSpec()],
                behaviours: Ml([YO(o, (e => {
                    const t = a.get(e);
                    return Em.getCurrent(t).bind((e => wu.getValue(e).hex)).map((e => "#" + _e(e, "#"))).getOr("")
                }
                ), ( (e, t) => {
              ...
              , d = hk.parts.field({
                factory: {
                    sketch: e => ({
                        ...
                        behaviours: Ml([KO(o.getOr([])), jO(), Um.config({}), bh.config({
                            toggleClass: "dragenter",
                            toggleOnExecute: !1
                        }), sh("dropzone-events", [jr("dragenter", s([n, bh.toggle])), jr("dragleave", s([n, bh.toggle])), jr("dragover", n), jr("drop", s([n, r])), jr(tr(), a)])]),
                        components: [{
                            dom: {
                                tag: "div",
              ...
              , a = hk.parts.field({
                ...
                factory: {
                    sketch: o => F_({
                        ...
                        presets: "normal",
                        classes: [],
                        dropdownBehaviours: [vk.config({}), YO(s.map((e => e.value)), (e => Tt(e.element, H_)), ( (t, o) => {
                            U_(e.items, o).each((e => {
        ...
        selectbox: rE(( (e, t, o) => ( (e, t, o) => {
            const n = V(e.items, (e => ({
              ...
              , r = hk.parts.field({
                ...
                options: n,
                factory: W_,
                selectBehaviours: Ml([Um.config({
                    disabled: () => !e.enabled || t.isDisabled()
                }), vk.config({}), sh("selectbox-change", [jr(tr(), ( (t, o) => {
                    Nr(t, Ck, {
                        name: e.name
                    })
                }
              ...
              , a = e.size > 1 ? A.none() : A.some(rb("chevron-down", {
                tag: "div",
        ...
        sizeinput: rE(( (e, t) => ( (e, t) => {
            ...
            const n = da("ratio-event")
              ...
              , i = q_.parts.lock({
                ...
                buttonBehaviours: Ml([Um.config({
                    disabled: () => !e.enabled || t.isDisabled()
                }), Ex(), vk.config({}), kx.config(t.tooltips.getConfig({
                    tooltipText: a
                }))])
            })
              , l = e => ({
              ...
              , c = o => hk.parts.field({
                ...
                inputBehaviours: Ml([Um.config({
                    disabled: () => !e.enabled || t.isDisabled()
                }), Ex(), vk.config({}), sh("size-input-events", [jr(Ks(), ( (e, t) => {
                    Nr(e, n, {
                        isField1: o
                    })
                }
            ...
            return q_.sketch({
                ...
                ,
                coupledFieldBehaviours: Ml([Um.config({
                    disabled: () => !e.enabled || t.isDisabled(),
                    onDisabled: e => {
                ...
                }), Ex(), sh("size-input-events2", [jr(n, ( (e, t) => {
                    ...
                    o = ( (e, t) => {
                        const o = Y_(e).toOptional()
                          , n = Y_(t).toOptional();
                        return Se(o, n, ( (e, t) => X_(e, t.unit).map((e => t.value / e)).map((e => {
                            return o = e,
                            n = t.unit,
                            e => X_(e, n).map((e => ({
                                value: e * o,
        ...
        urlinput: rE(( (e, t, o) => ( (e, t, o, n) => {
            const s = t.shared.providers
              ...
              , a = {
                ...
                fetch: n => {
                    const s = ( (e, t, o) => {
                        ...
                        return o.getLinkInformation().fold(( () => []), (t => {
                            ...
                            return "file" === e ? (s = [n, tE(a, JT(t)), tE(a, q([QT(t), ZT(t), eE(t)]))],
                            j(s, ( (e, t) => 0 === e.length || 0 === t.length ? e.concat(t) : e.concat(qT, t)), [])) : n;
                            var s
                        }
                        ))
                    }
                ...
                ,
                typeaheadBehaviours: Ml([...o.getValidationHandler().map((t => Wk.config({
                    getRoot: e => it(e.element),
                ...
                }), vk.config({}), sh("urlinput-events", [jr(er(), (t => {
                    const o = Ja(t.element)
                      , n = o.trim();
                    n !== o && Za(t.element, n),
                    "file" === e.filetype && Nr(t, Ck, {
                        name: e.name
                    })
                }
                )), jr(tr(), (t => {
            ...
            }, s.icons))("invalid", A.some(oE), "warning"))
              , d = Zh({
                dom: {
                    tag: "div",
            ...
            return hk.sketch({
                ...
                fieldBehaviours: Ml([Um.config({
                    ...
                    onDisabled: e => {
                        hk.getField(e).each(Um.disable),
                        p.getOpt(e).each(Um.disable)
                    }
                    ,
                    onEnabled: e => {
                        hk.getField(e).each(Um.enable),
                        p.getOpt(e).each(Um.enable)
                    }
                }), Ex(), sh("url-input-events", [jr(m, (t => {
        ...
        customeditor: rE((e => {
            const t = ac()
              ...
              , n = ac()
              , s = !QO(e) && e.onFocus.isSome() ? [ch.config({
                onFocus: t => {
                    e.onFocus.each((e => {
                        e(t.element.dom)
                    }
            ...
            return {
                ...
                behaviours: Ml([sh("custom-editor-events", [Zr((s => {
                    o.getOpt(s).each((o => {
                ...
                ))]), YO(A.none(), ( () => t.get().fold(( () => n.get().getOr("")), (e => e.getValue()))), ( (e, o) => {
        ...
        htmlpanel: rE(( (e, t) => ( (e, t) => "presentation" === e.presets ? uk.sketch({
            dom: {
                tag: "div",
                classes: ["tox-form__group"],
                innerHtml: e.html
            },
            containerBehaviours: Ml([kx.config({
                ...t.tooltips.getConfig({
                    tooltipText: "",
                    onShow: e => {
                        wi(e.element, "[data-mce-tooltip]:hover").orThunk(( () => Ul(e.element))).each((o => {
                            Et(o, "data-mce-tooltip").each((o => {
                                kx.setComponents(e, t.tooltips.getComponents({
                                    tooltipText: o
                                }))
        ...
        imagepreview: rE(( (e, t, o) => ( (e, t) => {
            ...
            return {
                ...
                components: [s.asSpec()],
                behaviours: Ml([jO(), YO(a, ( () => o.get()), ( (e, t) => {
                    const r = {
                        url: t.url
                    };
                    ...
                    n.getOpt(e).each((o => {
                        ...
                        new Promise(( (e, t) => {
                            ...
                            e.getSystem().isConnected() && (ja(e.element, "tox-imagepreview__loaded"),
        ...
        tree: rE(( (e, t) => ( (e, t) => {
            const o = e.onLeafAction.getOr(b)
              ...
              , i = da("tree-id")
              , l = (n, s) => e.items.map((e => "leaf" === e.type ? yT({
                leaf: e,
                selectedId: n,
                onLeafAction: o,
                visible: !0,
      ...
      , lE = (e, t, o, n) => {
        const s = vn(n, {
            shared: {
                interpreter: t => cE(e, t, o, s)
            }
        });
        return cE(e, t, o, s)
    }
      , cE = (e, t, o, n) => be(aE, t.type).fold(( () => (console.error(`Unknown factory type "${t.type}", defaulting to container: `, t),
    t)), (s => s(e, t, o, n)))
      ...
      , vE = (e, t, o) => Gi(pE(e, t), fE(e, t), o.insetSouthwest(), Ki(), "southwest", nl(e, {
        right: 0,
        bottom: 3
    }), uE)
      , yE = (e, t, o) => Gi(mE(e), fE(e, t), o.insetSoutheast(), Xi(), "southeast", nl(e, {
        left: 1,
        bottom: 3
    }), uE)
      , xE = (e, t, o) => Gi(pE(e, t), hE(e), o.insetNorthwest(), Yi(), "northwest", nl(e, {
        right: 0,
        top: 2
    }), uE)
      , wE = (e, t, o) => Gi(mE(e), hE(e), o.insetNortheast(), qi(), "northeast", nl(e, {
        left: 1,
        top: 2
    }), uE)
      , SE = (e, t, o) => Gi(gE(e, t), hE(e), o.insetNorth(), Ji(), "north", nl(e, {
        top: 2
    }), uE)
      , kE = (e, t, o) => Gi(gE(e, t), fE(e, t), o.insetSouth(), Zi(), "south", nl(e, {
        bottom: 3
    }), uE)
      , CE = (e, t, o) => Gi(pE(e, t), bE(e, t), o.insetEast(), el(), "east", nl(e, {
        right: 0
    }), uE)
      , OE = (e, t, o) => Gi(mE(e), bE(e, t), o.insetWest(), Qi(), "west", nl(e, {
        left: 1
    }), uE)
      , _E = e => {
        switch (e) {
      ...
      , xA = e => ({
        getHistory: pA,
        addToHistory: hA,
        getLinkInformation: () => (e => Pb(e) ? A.some({
            ...
            return {
                ...
                apis: {
                    setItems: (t, o) => {
                        var n;
                        (n = t,
                        e.shell ? A.some(n) : cm(n, e, "items")).fold(( () => {
            ...
            return {
                ...
                apis: {
                    setGroups: (t, o) => {
                        var n;
                        (n = t,
                        e.shell ? A.some(n) : cm(n, e, "groups")).fold(( () => {
      ...
      , DA = T
      , BA = x([]);
    var IA, FA = Object.freeze({
        __proto__: null,
        setup: MA,
        isDocked: DA,
        getBehaviours: BA
    });
    const RA = e => (xe(zt(e, "position"), "fixed") ? A.none() : lt(e)).orThunk(( () => {
        const t = Ne("span");
        return at(e).bind((e => {
            Ho(e, t);
            const o = lt(t);
      ...
      , NA = e => RA(e).map(Kt).getOrThunk(( () => Yt(0, 0)))
      , LA = (e, t) => {
        const o = e.element;
      ...
      , jA = (e, t, o) => o.getInitialPos().map((o => {
        const n = ( (e, t) => {
      ...
      , $A = (e, t, o) => o.getInitialPos().bind((n => {
        var s;
        ...
        case "absolute":
            ...
            return A.some({
                morph: "absolute",
                positionCss: jl("absolute", be(n.style, "left").map((e => t.x - r.x)), be(n.style, "top").map((e => t.y - r.y + a)), be(n.style, "right").map((e => r.right - t.right)), be(n.style, "bottom").map((e => r.bottom - t.bottom)))
            });
        default:
            return A.none()
        }
      ...
      , YA = (e, t, o) => {
        const n = e.element;
        return xe(zt(n, "position"), "fixed") ? ( (e, t, o) => ( (e, t, o) => jA(e, t, o).filter(( ({box: e}) => ( (e, t, o) => X(e, (e => {
            switch (e) {
            case "bottom":
        ...
        )))(o.getModes(), e, t))).bind(( ({box: t}) => $A(e, t, o))))(e, t, o).orThunk(( () => t.optScrollEnv.bind((n => jA(e, t, o))).bind(( ({box: e, location: o}) => {
            const n = on()
              , s = WA({
                win: n,
                box: e
            ...
            return "top" === r.location || "bottom" === r.location ? (GA(e, n, t, o, r),
            qA(r)) : A.none()
        }
        )(n, t, o)
    }
      ...
      , JA = (e, t, o, n, s=!1) => {
        t.contextual.each((t => {
            t.lazyContext(e).each((r => {
                ...
                s && !a ? (Ya(e.element, [t.fadeOutClass]),
                t.onHide(e)) : (a ? LA : zA)(e, t))
            }
            ))
        }
        ))
      ...
      , tM = e => (t, o, n) => {
        ...
        ( (e, t, o, n) => {
            ...
            return "bottom" === a.location || "top" === a.location ? (( (e, t, o, n, s) => {
                n.getInitialPos().fold(( () => GA(e, t, o, n, s)), ( () => b))
            }
            )(e, s, t, o, a),
            qA(a)) : A.none()
        }
    ...
    var sM = Object.freeze({
      ...
      , rM = Object.freeze({
        ...
        events: (e, t) => Pr([Jr(sr(), ( (o, n) => {
            e.contextual.each((e => {
                qa(o.element, e.transitionClass) && (Xa(o.element, [e.transitionClass, e.fadeInClass]),
      ...
      , aM = [xs("contextual", [is("fadeInClass"), is("fadeOutClass"), is("transitionClass"), cs("lazyContext"), zi("onShow"), zi("onShown"), zi("onHide"), zi("onHidden")]), Ts("lazyViewport", ( () => ({
        bounds: on(),
        optScrollEnv: A.none()
    }))), Es("modes", ["top", "bottom"], Pn), zi("onDocked"), zi("onUndocked")];
    const iM = Bl({
        fields: aM,
        name: "docking",
        active: rM,
      ...
      , gM = e => {
        ...
        it(t).each((o => {
            ...
            if (iM.isDocked(e)) {
                const e = Qt(o);
                It(t, "width", e + "px"),
                It(o, n, (e => $t(e) + (parseInt(Nt(e, "margin-top"), 10) || 0) + (parseInt(Nt(e, "margin-bottom"), 10) || 0))(t) + "px")
            } else
                Pt(t, "width"),
                Pt(o, n)
        }
      ...
      , pM = (e, t) => {
        t ? ($a(e, cM.fadeOutClass),
        Ya(e, [cM.transitionClass, cM.fadeInClass])) : ($a(e, cM.fadeInClass),
        Ya(e, [cM.fadeOutClass, cM.transitionClass]))
    }
      , hM = (e, t) => {
      ...
      , fM = (e, t) => {
        ...
        return [ch.config({}), iM.config({
            contextual: {
                ...
                onShown: e => {
                    ...
                    o.get().each((t => {
                        ( (e, t) => {
                            const o = ot(t);
                            Pl(o).filter((e => !et(t, e))).filter((t => et(t, ze(o.dom.body)) || tt(e, t))).each(( () => zl(t)))
                        }
                        )(e.element, t),
                        o.clear()
                    }
                ...
                ,
                onHide: e => {
                    ( (e, t) => Ul(e).orThunk(( () => t().toOptional().bind((e => Ul(e.element))))))(e.element, n).fold(o.clear, o.set),
                    s((e => pM(e, !1)))
                }
                ,
                onHidden: () => {
            ...
            lazyViewport: t => QS(e, t.element).fold(( () => {
                const o = on()
                  , n = Fb(e)
                  , s = o.y + (mM(t, "top") ? n : 0)
    ...
    const vM = In([ry, rs("items", Rn([Ln([ay, ms("items", Pn)]), Pn]))].concat(Ry))
      , yM = [fs("text"), fs("tooltip"), fs("icon"), Ss("search", !1, Rn([Un, In([fs("placeholder")])], (e => d(e) ? e ? A.some({
        placeholder: A.none()
    }) : A.none() : A.some(e)))), cs("fetch"), Ts("onSetup", ( () => b))]
      , xM = In([ry, ...yM])
    ...
    var kM = km({
        factory: (e, t) => {
            ...
            return {
                ...
                dom: e.dom,
                components: [],
                behaviours: Ml([nh.config({}), sh("menubar-events", [Zr((t => {
                    e.onSetup(t)
                }
                )), jr(Xs(), ( (e, t) => {
                    wi(e.element, ".tox-mbtn--active").each((o => {
                        Si(t.event.target, ".tox-mbtn").each((t => {
                            et(o, t) || e.getSystem().getByDom(o).each((o => {
                                e.getSystem().getByDom(t).each((e => {
                                    VS.expand(e),
                                    VS.close(o),
                                    ch.focus(e)
    ...
    const CM = "container"
      ...
      , TM = (e, t) => {
        const o = t => gm(e)
          , n = (t, o) => (n, s) => cm(n, e, s).map((e => t(e, s))).getOr(o)
      ...
      , BM = (e, t) => {
        ...
        return V(o, (t => {
            ...
            return e.slot(t.name, {
                ...
                behaviours: mx([Ix(t, n), Fx(t, n), jr(Ar(), ( (e, t) => {
                    const n = t.event
      ...
      , RM = e => Em.getCurrent(e).bind((e => gT.isGrowing(e) || gT.hasGrown(e) ? Em.getCurrent(e).bind((e => G(AM.getSlotNames(e), (t => AM.isShowing(e, t))))) : A.none()))
      , NM = da("FixSizeEvent")
      , LM = da("AutoSizeEvent");
    ...
    const HM = Bl({
      ...
      , UM = (e, t, o) => {
        const n = Ms(!1)
          ...
          , r = o => {
            var s;
            n.get() && (!(e => "focusin" === e.type)(s = o) || !(s.composed ? oe(s.composedPath()) : A.from(s.target)).map(ze).filter($e).exists((e => qa(e, "mce-pastebin")))) && (o.preventDefault(),
            PM(t()),
      ...
      , XM = x([Ni(["overflowToggledClass"]), vs("getOverflowBounds"), ss("lazySink"), os("overflowGroups", ( () => Ms([]))), zi("onOpened"), zi("onClosed")].concat(YM()))
      , KM = x([Xu({
        factory: AA,
        schema: TA(),
        name: "primary"
      ...
      , QM = x([Ku({
        ...
        name: "toolbar",
        overrides: e => ({
            toolbarBehaviours: Ml([Yp.config({
                mode: "cyclic",
                onEscape: t => (cm(t, e, "button").each(ch.focus),
                A.none())
            })])
        })
    })])
      ...
      , iD = Cm({
        ...
        factory: (e, t, o, n) => ({
            ...
            dom: e.dom,
            components: t,
            behaviours: Cu(e.tgroupBehaviours, [Yp.config({
                mode: "flow",
      ...
      , dD = Cm({
        ...
        factory: (e, t, o, n) => {
            ...
            return {
                ...
                dom: e.dom,
                components: t,
                behaviours: Cu(e.splitToolbarBehaviours, [yS.config({
                    others: {
                ...
                apis: {
                    setGroups: (t, o) => {
                        e.builtGroups.set(V(o, t.getSystem().build)),
                        cD(t, s, e)
                    }
                    ,
                    refresh: t => cD(t, s, e),
      ...
      , mD = x([Xu({
        ...
        name: "overflow",
        overrides: e => ({
            toolbarBehaviours: Ml([gT.config({
                dimension: {
                    property: "height"
                },
                ...
                mode: "acyclic",
                onEscape: t => (cm(t, e, "overflow-button").each(ch.focus),
                A.some(!0))
            })])
        })
    }), Ku({
      ...
      , gD = (e, t) => {
        cm(e, t, "overflow-button").bind(( () => cm(e, t, "overflow"))).each((o => {
            pD(e, t),
            gT.toggleGrow(o)
        }
        ))
      ...
      , hD = Cm({
        ...
        factory: (e, t, o, n) => {
            ...
            return {
                ...
                }), sh("toolbar-toggle-events", [jr(s, (t => {
                    gD(t, e)
                }
                ))])]),
                apis: {
      ...
      , vD = (e, t) => {
        ...
        return Ml([Dx(e.providers.isDisabled), Ex(), Yp.config({
            mode: t,
            onEscape: e.onEscape,
        ...
        const s = "togglebutton" === e.type
          ...
          , h = HT(a, A.some((o => {
            ...
            return s ? e.onAction({
                ...
                setActive: e => {
                    const t = o.element;
                    e ? (ja(t, "tox-button--enabled"),
                    Ot(t, "aria-pressed", !0)) : ($a(t, "tox-button--enabled"),
                    Mt(t, "aria-pressed"))
                }
                ,
    ...
    var BD = Cm({
        ...
        partFields: [Ju({
            factory: {
                sketch: e => {
                    let t = !1;
                    const o = V(e.buttons, (o => "group" === o.type ? (t = !0,
                    ( (e, t) => ({
                        dom: {
                            tag: "div",
                    ...
                    return {
                        ...
                        behaviours: Ml([ch.config({}), Yp.config({
                            mode: "flow",
                            selector: "button, .tox-button",
                            focusInside: wg.OnEnterOrSpaceMode
                        })]),
                        components: t ? o : [uk.sketch({
                            dom: {
                                tag: "div",
    ...
    var LD = km({
        factory: (e, t) => {
            const o = {
                ...
                toggleView: (e, t, o, n) => Em.getCurrent(e).exists((s => {
                    const r = RD(s)
                      , a = r.exists((e => n === e))
                      , i = AM.getSlot(s, n).isSome();
                    return i && (AM.hideAllSlots(s),
                    a ? ((e => {
                        const t = e.element;
                        It(t, "display", "none"),
                        Ot(t, "aria-hidden", "true")
                    }
                    )(e),
                    t()) : (o(),
                    (e => {
            ...
            return {
                ...
                components: [],
                behaviours: Ml([nh.config({}), Em.config({
                    find: e => {
        ...
        factory: {
            sketch: e => ({
                ...
                components: [{
                    ...
                    components: [],
                    behaviours: Ml([vk.config({}), ch.config({}), gT.config({
                        dimension: {
                            property: "width"
                        },
                        ...
                        onShrunk: e => {
                            Em.getCurrent(e).each(AM.hideAllSlots),
                            Rr(e, LM)
                        }
                        ,
                        onGrown: e => {
                        ...
                        onStartGrow: e => {
                            Nr(e, NM, {
                                width: zt(e.element, "width").getOr("")
                            })
                        }
                        ,
                        onStartShrink: e => {
                            Nr(e, NM, {
                                width: Qt(e.element) + "px"
                            })
                        }
                    }), nh.config({}), Em.config({
                        find: e => {
                ...
                behaviours: Ml([GO(0), sh("sidebar-sliding-events", [jr(NM, ( (e, t) => {
      ...
      , GD = SA.optional({
        factory: {
            sketch: e => ({
                ...
                behaviours: Ml([nh.config({}), HM.config({
                    focus: !1
                }), Em.config({
        ...
        factory: (e, t, o) => {
            ...
            const s = e => {
                yi(e, ".tox-statusbar").each((e => {
                    "none" === Nt(e, "display") && "true" === Tt(e, "aria-hidden") ? (Pt(e, "display"),
                    Mt(e, "aria-hidden")) : (It(e, "display", "none"),
                    Ot(e, "aria-hidden", "true"))
                }
                ))
            }
              , a = {
                ...
                setSidebar: (t, o, n) => {
                    wA.getPart(t, e, "sidebar").each((e => ( (e, t, o) => {
                        Em.getCurrent(e).each((n => {
                            nh.set(n, [IM(t)]);
                            const s = null == o ? void 0 : o.toLowerCase();
                            r(s) && ve(t, s) && Em.getCurrent(n).each((t => {
                                AM.showSlot(t, s),
                                gT.immediateGrow(n),
                                Pt(n.element, "width"),
                                FM(e.element, "region")
                ...
                ,
                toggleSidebar: (t, o) => {
                    wA.getPart(t, e, "sidebar").each((e => ( (e, t) => {
                        Em.getCurrent(e).each((o => {
                            Em.getCurrent(o).each((n => {
                                gT.hasGrown(o) ? AM.isShowing(n, t) ? (gT.shrink(o),
                                FM(e.element, "presentation")) : (AM.hideAllSlots(n),
                                AM.showSlot(n, t),
                                FM(e.element, "region")) : (AM.hideAllSlots(n),
                                AM.showSlot(n, t),
                                gT.grow(o),
                                FM(e.element, "region"))
                            }
                ...
                ,
                isToolbarDrawerToggled: t => wA.getPart(t, e, "toolbar").bind((e => A.from(e.getApis().isOpen).map((t => t(e))))).getOr(!1),
                getThrobber: t => wA.getPart(t, e, "throbber"),
                focusToolbar: t => {
                    wA.getPart(t, e, "toolbar").orThunk(( () => wA.getPart(t, e, "multiple-toolbar"))).each((e => {
                        Yp.focusIn(e)
                    }
                    ))
                }
                ...
                ,
                toggleView: (t, o) => wA.getPart(t, e, "viewWrapper").exists((e => LD.toggleView(e, ( () => a.showMainView(t)), ( () => a.hideMainView(t)), o))),
    ...
    o.load(t))
      , QD = (e, t, o, n) => (e.on("remove", ( () => n.unloadRawCss(t))),
    n.loadRawCss(t, o))
      , eB = async (e, t) => {
      ...
      , tB = async (e, t) => {
        var o;
        if (o = ze(e.getElement()),
        yt(o).isSome()) {
            const o = "ui/" + nv(e).getOr("default") + "/skin.shadowdom.css"
              , n = tinymce.Resource.get(o);
            return r(n) ? (QD(e, o, n, db.DOM.styleSheetLoader),
            Promise.resolve()) : ZD(e, t + "/skin.shadowdom.min.css", db.DOM.styleSheetLoader)
        }
    }
      , oB = (e, t) => (async (e, t) => {
        nv(t).fold(( () => {
            ...
            if (r(s))
                QD(t, n, s, t.ui.styleSheetLoader);
            else {
                const o = ov(t);
                o && t.contentCSS.push(o + (e ? "/content.inline" : "/content") + ".min.css")
            }
        ...
        const o = ov(t);
        if (!ev(t) && r(o))
            return Promise.all([eB(t, o), tB(t, o)]).then()
    }
    )(e, t).then((e => {
        const t = () => {
            e._skinLoaded = !0,
                ...
                ...t.shared.providers.tooltips.getConfig({
                    ...
                    onShow: e => {
                        if (o.tooltip !== l.get()) {
                            ...
                            kx.setComponents(e, t.shared.providers.tooltips.getComponents({
                                tooltipText: o
                            }))
                        }
                    }
    ...
    const dB = (e, t, o) => {
        const n = (s = ( (e, t) => t === cB.SemiColon ? e.replace(/;$/, "").split(";") : e.split(" "))(e.options.get(t), o),
        V(s, (e => {
            let t = e
              , o = e;
            const n = e.split("=");
    ...
    )(72 * parseInt(e, 10) / 96, t || 0) + "pt" : be(BB, e).getOr(e)
      , FB = e => be(DB, e).getOr("")
      , RB = e => {
        const t = () => {
            let t = A.none();
      ...
      , LB = (e, t) => {
        ...
        return {
            ...
            onAction: _w(e),
            updateText: t => {
                const n = e => UE(e) ? Y(e.items, n) : WE(e) ? [{
                    title: e.title,
                    format: e.format
                }] : []
                  , s = Y($E(e), n)
      ...
      , zB = x([ss("toggleClass"), ss("fetch"), Hi("onExecute"), ws("getHotspot", A.some), ws("getAnchorOverrides", x({})), Ec(), Hi("onItemExecute"), gs("lazySink"), ss("dom"), zi("onOpen"), Su("splitDropdownBehaviours", [yS, Yp, ch]), ws("matchWidth", !1), ws("useMinWidth", !1), ws("eventOrder", {}), gs("role")].concat(NS()))
      , VB = Xu({
        factory: Kh,
        schema: [ss("dom")],
        name: "arrow",
        defaults: () => ({
            buttonBehaviours: Ml([ch.revoke()])
        }),
        overrides: e => ({
            dom: {
                tag: "span",
      ...
      , UB = Cm({
        ...
        factory: (e, t, o, n) => {
              ...
              , i = {
                ...Pr([Zr(( (t, o) => {
                    cm(t, e, "aria-descriptor").each((e => {
                        const o = da("aria");
                        Ot(e.element, "id", o),
                        Ot(t.element, "aria-describedby", o)
                    }
                    ))
                }
                ))]),
            ...
            return {
                ...
                events: i,
                behaviours: Cu(e.splitDropdownBehaviours, [yS.config({
                    others: {
                        sandbox: t => {
      ...
      , qB = (e, t, o, n, s, r) => {
        ...
        return {
            ...
            buttonBehaviours: Ml([Dx(s.isDisabled), Ex(), sh(O_, [Zr(( (e, t) => T_(e))), jr(B_, ( (e, t) => {
                a.bind((t => t.getOpt(e))).each((e => {
      ...
      , YB = (e, t, o, n) => {
        ...
        return Kh.sketch({
            ...
            buttonBehaviours: {
                ...
                ))), Ix(t, r), Fx(t, r)]), ...e.tooltip.map((t => kx.config(o.tooltips.getConfig({
                    tooltipText: o.translate(t) + e.shortcut.map((e => ` (${Hx(e)})`)).getOr("")
                })))).toArray(), Dx(( () => !e.enabled || o.isDisabled())), Ex()].concat(t.toolbarButtonBehaviours)),
      ...
      , KB = (e, t, o, n) => YB(e, {
        toolbarButtonBehaviours: [nh.config({}), bh.config({
      ...
      , JB = (e, t, o) => n => CS((e => t.fetch(e))).map((s => A.from(qS(vn(aS(da("menu-value"), s, (o => {
        t.onItemAction(e(n), o)
    }
    ), t.columns, t.presets, vv.CLOSE_ON_EXECUTE, t.select.getOr(T), o), {
        movement: lS(t.columns, t.presets),
        menuBehaviours: mx("auto" !== t.columns ? [] : [Zr(( (e, o) => {
      ...
      , eI = {
        ...
        splitbutton: QB((e => Xn("SplitButton", SM, e)), ( (e, t, o, n) => ( (e, t, o) => {
              ...
              , s = e => ({
                ...
                setActive: t => {
                    ...
                    wi(e.element, "span").each((o => {
                        e.getSystem().getByDom(o).each((e => bh.set(e, t)))
                    }
                    ))
                }
                ,
                isActive: () => wi(e.element, "span").exists((t => e.getSystem().getByDom(t).exists(bh.isOn))),
                setText: t => wi(e.element, "span").each((o => e.getSystem().getByDom(o).each((e => Nr(e, B_, {
                    text: t
                }))))),
                setIcon: t => wi(e.element, "span").each((o => e.getSystem().getByDom(o).each((e => Nr(e, I_, {
                    icon: t
                }))))),
                setTooltip: o => {
                    const s = t.providers.translate(o);
                    Ot(e.element, "aria-label", s),
                    n.set(o)
                }
            })
              , r = Ms(b)
            ...
            return UB.sketch({
                ...
                onItemExecute: (e, t, o) => {}
                ,
                splitDropdownBehaviours: Ml([Mx(t.providers.isDisabled), Ex(), sh("split-dropdown-events", [Zr(( (e, t) => T_(e))), jr($B, ch.focus), Ix(a, r), Fx(a, r)]), jk.config({}), ...e.tooltip.map((e => kx.config({
                    ...t.providers.tooltips.getConfig({
                        tooltipText: t.providers.translate(e),
                        onShow: o => {
                            if (n.get() !== e) {
                                const e = t.providers.translate(n.get());
                                kx.setComponents(o, t.providers.tooltips.getComponents({
                                    tooltipText: e
                                }))
                            }
                        }
                ...
                parts: {
                    menu: Nv(0, e.columns, e.presets)
                },
                components: [UB.parts.button(qB(e.icon, e.text, A.none(), A.some([bh.config({
                    toggleClass: "tox-tbtn--enabled",
                    toggleOnExecute: !1
        ...
        grouptoolbarbutton: QB((e => Xn("GroupToolbarButton", vM, e)), ( (e, t, o, n) => {
            const s = o.ui.registry.getAll().buttons
              , r = {
                [_c]: t.shared.header.isPositionedAtTop() ? Oc.TopToBottom : Oc.BottomToTop
            };
            if (Eb(o) === lb.floating)
                return ( (e, t, o, n, s) => {
                    const r = t.shared
      ...
      , tI = {
        ...
        fontsizeinput: (e, t) => ( (e, t, o, n) => {
            ...
            const r = Ow(e, "NodeChange SwitchMode", (t => {
              ...
              , d = (e, t) => c(( (e, t) => e - t), e, t)
              , u = (e, t) => c(( (e, t) => e + t), e, t)
              , m = e => it(e.element).fold(A.none, (e => (zl(e),
            A.some(!0))))
              , p = e => Hl(e.element) ? (ut(e.element).each((e => zl(e))),
            A.some(!0)) : A.none()
              , h = (o, n, s, r) => {
                const i = Ms(b)
                ...
                return Kh.sketch({
                    ...
                    buttonBehaviours: Ml([Um.config({}), kx.config(t.shared.providers.tooltips.getConfig({
                        tooltipText: l
                    })), sh(c, [Ix({
                        onSetup: d,
                        getApi: a
              ...
              , y = Zh({
                ...
                components: [Pv.sketch({
                    inputBehaviours: Ml([Um.config({}), sh(l, [Ix({
                        onSetup: r,
                        getApi: a
                    }, i), Fx({
                        getApi: a
                    }, i)]), sh("input-update-display-text", [jr(B_, ( (e, t) => {
                ...
                behaviours: Ml([ch.config({}), Yp.config({
                    ...
                    onSpace: p,
                    onEscape: m
                }), sh("input-wrapper-events", [jr(Xs(), (e => {
                    H([f, v], (t => {
            ...
            return {
                ...
                behaviours: Ml([ch.config({}), Yp.config({
                    ...
                    onEscape: e => Hl(e.element) ? A.none() : (zl(e.element),
                    A.some(!0))
                })])
            }
        }
      ...
      , oI = (e, t, o, n) => {
        const s = (e => {
          ...
          , a = V(s, (s => {
            const r = Y(s.items, (s => 0 === s.trim().length ? [] : ( (e, t, o, n, s, r) => be(t, o.toLowerCase()).orThunk(( () => r.bind((e => re(e, (e => be(t, e + o.toLowerCase()))))))).fold(( () => be(tI, o.toLowerCase()).map((t => t(e, s)))), (t => "grouptoolbarbutton" !== t.type || n ? ( (e, t, o, n) => be(eI, e.type).fold(( () => (console.error("skipping button defined by", e),
            A.none())), (s => A.some(s(e, t, o, n)))))(t, s, e, o.toLowerCase()) : (console.warn(`Ignoring the '${o}' toolbar button. Group toolbar buttons are only supported when using floating toolbar mode and cannot be nested.`),
      ...
      , nI = (e, t, o, n) => {
        ...
        if (f(a, r)) {
            ...
            YD.setToolbar(s, oI(e, o, n, A.none()))
    }
      , sI = Io()
    ...
    var aI = Object.freeze({
        ...
        render: (e, t, o, n, s) => {
            ...
            e.on("SkinLoaded", ( () => {
                ...
                ( (e, t) => {
                    ...
                    const r = e.getDoc().documentElement
                      ...
                      , l = () => {
                        const t = a.get();
                        t.left === s.innerWidth && t.top === s.innerHeight || (a.set(Yt(s.innerWidth, s.innerHeight)),
                        yw(e))
                    }
                      , c = () => {
                        const t = e.getDoc().documentElement
                          , o = i.get();
                        o.left === t.offsetWidth && o.top === t.offsetHeight || (i.set(Yt(t.offsetWidth, t.offsetHeight)),
                        yw(e))
                    }
                      , d = t => {
                        ( (e, t) => {
            ...
            const g = Eb(e);
            g !== lb.sliding && g !== lb.floating || e.on("ResizeWindow ResizeEditor ResizeContent", ( () => {
                const o = e.getWin().innerWidth;
                o !== i.get() && (YD.refreshToolbar(t.mainUi.outerContainer),
                i.set(o))
            }
            ));
            const p = {
      ...
      , gI = (e, t, o, n, s) => {
        const {mainUi: r, uiMotherships: a} = o
          ...
          , y = o => {
            ...
            const n = jo()
              , a = !(l || l || !(Kt(r.outerContainer.element).left + eo(r.outerContainer.element) >= window.innerWidth - 40 || zt(r.outerContainer.element, "width").isSome()) || (It(r.outerContainer.element, "position", "absolute"),
            It(r.outerContainer.element, "left", "0px"),
            Pt(r.outerContainer.element, "width"),
            0));
            if (p && YD.refreshToolbar(r.outerContainer),
            !l) {
                const o = jo()
                    ...
                    s.on((s => {
                        const a = YD.getToolbar(r.outerContainer)
                          ...
                          , u = Ce(o, Math.ceil(r.outerContainer.element.dom.getBoundingClientRect().width)).filter((e => e > 150)).map((e => {
                            ...
                            return o < e && It(r.outerContainer.element, "width", s + "px"),
                            {
                                width: s + "px"
                            }
                        }
                          ...
                          , g = {
                            ...
                            top: c.fold(( () => m() ? Math.max(l.y - Gt(s.element) + i, 0) : l.bottom), (e => {
                                var t;
                                const o = Qo(e)
    ...
    var hI = Object.freeze({
        ...
        render: (e, t, o, n, s) => {
            ...
            const d = () => {
                ...
                const s = uv(e);
                pv(e) ? (Ud(i, r.mothership),
                Ud(i, t.popupUi.mothership)) : Pd(s, r.mothership),
                    ...
                    ( (e, t, o, n) => {
                        const s = Ms(pI(t, o.isPositionedAtTop()))
                          , r = n => {
                            ...
                            c && yw(e, n),
                            o.isVisible() && (i !== r ? o.update(iM.reset) : c && (o.updateMode(),
                            o.repositionPopups()))
                        }
                        ;
    ...
    const fI = "contexttoolbar-hide"
      ...
      , vI = (e, t) => {
        const o = e.label.fold(( () => ({})), (e => ({
          ...
          , n = Zh(Pv.sketch({
            ...
            inputAttributes: o,
            selectOnFocus: !0,
            inputBehaviours: Ml([Yp.config({
                mode: "special",
                onEnter: e => s.findPrimary(e).map((e => (Lr(e),
                !0))),
                onLeft: (e, t) => (t.cut(),
                A.none()),
                onRight: (e, t) => (t.cut(),
          ...
          , s = ( (e, t, o) => {
            const n = V(t, (t => Zh(( (e, t, o) => (e => "contextformtogglebutton" === e.type)(t) ? ( (e, t, o) => {
            ...
            return {
                ...
                findPrimary: e => re(t, ( (t, o) => t.primary ? A.from(n[o]).bind((t => t.getOpt(e))).filter(C(Um.isDisabled)) : A.none()))
            }
        }
        )(n, e.commands, t);
        return [{
      ...
      , xI = e => {
        const t = (e => {
            ...
            if (t.height <= 0 && t.width <= 0) {
                ...
                return (qe(o) ? at(o) : A.some(o)).filter($e).map((e => e.dom.getBoundingClientRect())).getOr(t)
            }
            return t
        }
        )(e.selection.getRng());
      ...
      , OI = (e, t, o, n, s) => {
        ...
        return ( (e, t) => {
            ...
            return a.each((t => It(e, "position", t))),
            i
        }
        )(t, n.getMode()) : ("fixed" === n.getMode() ? s.y + jo().top : s.y) + (Gt(t) + 12) <= r.y ? SE : kE
    }
      , _I = (e, t, o, n) => {
        const s = t => (n, s, r, a, i) => ({
            ...OI(e, a, t, o, i)({
      ...
      , FI = (e, t, o, n) => {
        const s = n.backstage
          ...
          , d = di((e => {
            ...
            return Yh.sketch({
                ...
                ,
                inlineBehaviours: Ml([sh("context-toolbar-events", [Jr(sr(), ( (e, t) => {
                    "width" === t.event.raw.propertyName && ($a(e.element, BI),
                    Pt(e.element, "width"))
                }
                )), jr(DI, ( (e, t) => {
                    const o = e.element;
                    Pt(o, "width");
                    const n = Qt(o);
                    Yh.setContent(e, t.event.contents),
                    ja(o, BI);
                    const s = Qt(o);
                    It(o, "width", n + "px"),
                    Yh.getContent(e).each((e => {
                        t.event.focus.bind((e => (zl(e),
                        Ul(o)))).orThunk(( () => (Yp.focusIn(e),
                        Pl(bt(o)))))
                    }
                    )),
                    setTimeout(( () => {
                    ...
                    mode: "special",
                    onEscape: o => ne(t.get()).fold(( () => e.onEscape()), (e => (Rr(o, MI),
                    A.some(!0))))
                })]),
          ...
          , g = () => {
            if (m()) {
                const t = u()
                  , o = xe(c.get(), "node") ? ( (e, t) => t.filter((e => wt(e) && Ge(e))).map(en).getOrThunk(( () => xI(e))))(e, i.get()) : xI(e);
          ...
          , f = t => ({
            ...
            behaviours: Ml([Yp.config({
                mode: "acyclic"
            }), sh("pop-dialog-wrap-events", [Zr((t => {
          ...
          , y = t => {
            const {buttons: o} = e.ui.registry.getAll()
              ...
              , i = q(V(t, (t => "contexttoolbar" === t.type ? ( (t, o) => oI(e, {
                buttons: t,
                toolbar: o.items,
                allowToolbarGroups: !1
          ...
          , x = (t, n) => {
            ...
            const b = d.element;
            Pt(b, "display"),
            (e => xe(Se(e, i.get(), et), !0))(n) || ($a(b, II),
            Ad.reset(o, d)),
            Yh.showWithinBounds(d, f(s), {
                anchor: h,
                transition: {
                    classes: [II],
                    mode: "placement"
        ...
        let w = !1;
        const S = t_(( () => {
            !e.hasFocus() || e.removed || w || (qa(d.element, II) ? S.throttle() : ( (e, t) => {
                const o = ze(t.getBody())
                  , n = e => et(e, o)
                  , s = ze(t.selection.getNode());
                return (e => !n(e) && !tt(o, e))(s) ? A.none() : ( (e, t, o) => {
                    const n = TI(e, t);
      ...
      , NI = e => {
        ...
        (e => A.from(_b(e)).map((t => ({
            ...
            getCurrent: e => {
                ...
                return Ns(t, (e => A.some(e).filter($e).bind((e => Et(e, "lang").map((t => ({
                    code: t,
      ...
      , PI = (e, t) => Ow(e, "Undo Redo AddUndo TypingUndo ClearUndos SwitchMode", (o => {
        o.setEnabled(!e.mode.isReadOnly() && e.undoManager[t]())
    }
    ))
      , UI = e => Ow(e, "VisualAid", (t => {
      ...
      , iF = (e, t) => {
        if (0 === t.length)
            return e;
        const o = ne(e).filter((e => !sF(e))).fold(( () => []), (e => [rF]));
      ...
      , dF = (e, t, o) => {
        const n = Io().deviceType.isTouch
          , s = di(Yh.sketch({
            ...
            fireDismissalEventInstead: {},
            inlineBehaviours: Ml([sh("dismissContextMenu", [jr(_r(), ( (t, o) => {
                tu.close(t),
                e.focus()
            }
            ))])])
          ...
          , i = t => {
            ...
            (n() ? nF : eF)(e, t, ( () => {
                ...
                return ( (e, t, o) => {
                    ...
                    return n.length > 0 && sF(n[n.length - 1]) && n.pop(),
                    n
                }
                )(n.contextMenus, s, o)
            }
      ...
      , CF = (e, t, o, n, s, r) => {
        ...
        return ( (e, t, o) => {
            const n = e.element;
            Ot(n, t.leftAttr, o.left + "px"),
            Ot(n, t.topAttr, o.top + "px")
        }
        )(e, t, l),
        i.fold(( () => ({
    ...
    const AF = "data-initial-z-index"
      ...
      , DF = e => {
        (e => {
            at(e.element).filter($e).each((e => {
                Et(e, AF).fold(( () => Pt(e, "z-index")), (t => It(e, "z-index", t))),
                Mt(e, AF)
            }
            ))
        }
      ...
      , BF = (e, t, o) => e.getSystem().build(uk.sketch({
        dom: {
            styles: {
                left: "0px",
                top: "0px",
    ...
    const FF = [ws("useFixed", T), ss("blockerClass"), ws("getTarget", w), ws("onDrag", b), ws("repositionTarget", !0), ws("onDrop", b), Ts("getBounds", on), IF]
      , RF = e => {
        ...
        o = zt(e, "top"),
        n = zt(e, "position"),
        t.isSome() && o.isSome() && n.isSome() ? A.some(( (e, t, o) => ("fixed" === o ? SF : xF)(parseInt(e, 10), parseInt(t, 10)))(t.getOrDie(), o.getOrDie(), n.getOrDie())) : A.none()).getOrThunk(( () => {
            const t = Kt(e);
                ...
                if (t.repositionTarget) {
                    const r = ot(e.element)
                      ...
                      , c = ( (e, t, o, n, s, r, a) => ( (e, t, o, n, s) => {
                        ...
                        a = r.left,
                        i = r.top,
                        t.fold(( (e, t) => xF(e + a, t + i)), ( (e, t) => wF(e + a, t + i)), ( (e, t) => SF(e + a, t + i))));
                        var t, a, i;
                        const l = hF(e, n, s);
    ...
    const PF = (e, t, o) => [jr(Gs(), ( (n, s) => {
        ...
        const r = () => zF(n, A.some(l), e, t)
          ...
          , l = BF(n, e.blockerClass, (e => Pr([jr(Gs(), e.forceDrop), jr(Ys(), e.drop), jr($s(), ( (t, o) => {
            e.move(o.event)
        }
        )), jr(qs(), e.delayDrop)]))(i));
        o(n),
    ...
    const jF = (e, t, o) => {
        ...
        return [jr(Ps(), ( (r, a) => {
            ...
            const i = () => s(r)
              ...
              , c = BF(r, e.blockerClass, (e => Pr([jr(Ps(), e.forceDrop), jr(Ws(), e.drop), jr(js(), e.drop), jr(Us(), ( (t, o) => {
                e.move(o.event)
            }
            ))]))(l));
            n.set(c),
    ...
    const KF = Fl({
      ...
      , ZF = (e, t, o) => ({
        ...
        onSensor: (e, n) => {
            const s = n.td;
            ( (e, t) => e.exists((e => et(e, t))))(t.get(), s) || (t.set(s),
            o(s))
        }
        ,
        mustSnap: !0
      ...
      , tR = (e, t, o) => {
        ...
        return {
            ...
            }), Ex(), vk.config({}), nh.config({}), sh("elementPathEvents", [Zr(( (t, n) => {
    ...
    const nR = (e, t, o) => {
        const n = ze(e.getContainer())
          , s = ( (e, t, o, n, s) => {
            const r = {
                height: cI(n + t.top, xb(e), Sb(e))
            };
            return o === oR.Both && (r.width = cI(s + t.left, yb(e), wb(e))),
            r
        }
        )(e, t, o, Gt(n), Qt(n));
        le(s, ( (e, t) => {
            ...
            r && o.push(( () => {
                ...
                return e.hasPlugin("wordcount") && o.push(( (e, t) => {
                    ...
                    return Kh.sketch({
                        ...
                        components: [],
                        buttonBehaviours: Ml([Ax(t.isDisabled), Ex(), vk.config({}), nh.config({}), wu.config({
                            store: {
                                mode: "memory",
                                initialValue: {
                                    mode: "words",
            ...
            components: ( () => {
                const n = o()
                  , s = ( (e, t) => {
                    ...
                    return A.some(rb("resize-handle", {
                        tag: "div",
                        ...
                        behaviours: [KF.config({
                            ...
                            onUp: () => sR(e, o, 0, -1),
                            onDown: () => sR(e, o, 0, 1)
                        }), vk.config({}), ch.config({}), kx.config(t.tooltips.getConfig({
      ...
      , iR = (e, t) => {
        const o = e.inline
          ...
          , r = ( () => {
            ...
            return {
                ...
                getUiMotherships: () => {
                    ...
                    return o.fold(( () => n.toArray()), (e => n.fold(( () => [e]), (t => et(e.element, t.element) ? [e] : [e, t]))))
                }
                ,
          ...
          , y = ( (e, t, o, n) => {
            ...
            popup: () => an.fromOption(r.popupUi.get().map((e => e.sink)), "(popup) UI has not been rendered"),
            dialog: () => an.fromOption(r.dialogUi.get().map((e => e.sink)), "UI has not been rendered")
        }, e, h, f)
          , x = () => {
            const t = ( () => {
                const t = {
                    attributes: {
                        [_c]: d ? Oc.BottomToTop : Oc.TopToBottom
                    }
                }
                  , o = YD.parts.menubar({
                    dom: {
          ...
          , w = t => {
            ...
            return e.inline || (Ht("div", "width", n) && It(t.element, "width", n),
            Ht("div", "height", o) ? It(t.element, "height", o) : It(t.element, "height", "400px")),
            o
        }
        ;
        return {
                          ...
                          , v = cc(b, "scroll", (o => {
                            requestAnimationFrame(( () => {
                                if (null != e.getContainer()) {
                                    const s = QS(e, t.element).map((e => [e.element, ...e.others])).getOr([]);
                                    N(s, (e => et(e, o.target))) && (e.dispatch("ElementScroll", {
                                        target: o.target.dom
                                    }),
                                    n(Mr(), o))
                                }
      ...
      , lR = x([ss("lazySink"), gs("dragBlockClass"), Ts("getBounds", on), ws("useTabstopAt", E), ws("firstTabstop", 0), ws("eventOrder", {}), Su("modalBehaviours", [Yp]), Vi("onExecute"), Pi("onEscape")])
      , cR = {
        sketch: w
    }
      , dR = x([Ju({
      ...
      , uR = Cm({
        ...
        factory: (e, t, o, n) => {
            ...
            return {
                    ...
                    show: t => {
                        ...
                        const o = e.lazySink(t).getOrDie()
                          ...
                          , a = o.getSystem().build({
                            ...
                            behaviours: Ml([ch.config({}), sh("dialog-blocker-events", [Jr(Ks(), ( () => {
                ...
                behaviours: Cu(e.modalBehaviours, [nh.config({}), Yp.config({
                    mode: "cyclic",
                    onEnter: e.onExecute,
                    onEscape: e.onEscape,
      ...
      , SN = In(wN)
      , kN = wN.concat([ms("children", es(0, ( () => $n("type", {
        directory: CN,
        leaf: SN
    }))))])
      , CN = In(kN)
      ...
      , DN = e => ts("items", "items", {
        tag: "required",
        process: {}
    }, Fn(qn((t => Xn(`Checking item of ${e}`, BN, t).fold((e => an.error(Zn(e))), (e => an.value(e)))))))
      , BN = Mn(( () => {
        return $n("type", {
            alertbanner: wR,
            bar: In((e = DN("bar"),
      ...
      , zN = hR
      , VN = yR
      , HN = In([is("title"), rs("body", $n("type", {
        panel: FN,
        tabpanel: LN
    })), Cs("size", "normal"), Es("buttons", [], VN), ws("initialData", {}), Ts("onAction", b), Ts("onChange", b), Ts("onSubmit", b), Ts("onClose", b), Ts("onCancel", b), Ts("onTabChange", b)])
      ...
      , $N = e => {
        const t = (e => U(WN(e), jN))(e)
          , o = Y(t, (e => (e => A.from(GN[e.type]))(e).fold(( () => []), (t => [rs(e.name, t)]))));
        return In(o)
    }
      , qN = e => {
        var t;
    ...
    const ZN = Bl({
      ...
      , eL = (e, t, o) => {
        ...
        return {
            ...
            Em.config({
                ...
                postprocess: e => QN(e).fold((e => (console.error(e),
                {})), w)
            }), sh("dialog-body-panel", [jr(Ks(), ( (e, t) => {
      ...
      , tL = km({
        name: "TabButton",
        configFields: [ws("uid", void 0), ss("value"), ts("dom", "dom", Sn(( () => ({
            attributes: {
                role: "tab",
                id: da("aria"),
                "aria-selected": "false"
            }
        }))), zn()), gs("action"), ws("domModification", {}), Su("tabButtonBehaviours", [ch, Yp, wu]), ss("view")],
        factory: (e, t) => ({
            uid: e.uid,
            dom: e.dom,
            components: e.components,
            events: yh(e.action),
            behaviours: Cu(e.tabButtonBehaviours, [ch.config({}), Yp.config({
                mode: "execution",
                useSpace: !0,
                useEnter: !0
            }), wu.config({
      ...
      , rL = Cm({
        ...
        factory: (e, t, o, n) => ({
            ...
            behaviours: Cu(e.tabbarBehaviours, [Zm.config({
      ...
      , uL = Cm({
        ...
        factory: (e, t, o, n) => {
            ...
            return {
                ...
                events: Pr(q([e.selectFirst ? [Zr(( (e, t) => {
                    s(e, Zm.getFirst)
                }
                ))] : [], [jr(Dr(), ( (t, o) => {
                    (t => {
                ...
                apis: {
                    getViewItems: t => cm(t, e, "tabview").map((e => nh.contents(e))).getOr([]),
                    showTab: (e, t) => {
                        s(e, (e => {
      ...
      , bL = (e, t, o) => {
        const n = Ms({})
          ...
          , i = V(e.tabs, (e => ({
            ...
            view: () => [LO.sketch((n => ({
                ...
                components: V(e.items, (e => lE(n, e, t, o))),
                formBehaviours: Ml([Yp.config({
                    mode: "acyclic",
                    useTabstopAt: C(l_)
                }), sh("TabView.form.events", [Zr(r), Qr(s)]), Nl.config({
                    channels: Is([{
                        key: hL,
                        value: {
                            onReceive: s
        ...
        return uL.sketch({
            ...
            tabSectionBehaviours: Ml([sh("tabpanel", l.extraEvents), Yp.config({
                mode: "acyclic"
            }), Em.config({
                find: e => oe(uL.getViewItems(e))
            }), YO(A.none(), (e => (e.getSystem().broadcastOn([hL], {}),
            n.get())), ( (e, t) => {
                n.set(t),
                e.getSystem().broadcastOn([fL], {})
            }
            ))])
        })
    }
      ...
      , wL = (e, t) => uR.parts.close(Kh.sketch({
        dom: {
            tag: "button",
      ...
      , _L = e => {
        ...
        return uR.sketch({
            ...
            dragBlockClass: o,
            modalBehaviours: Ml([ch.config({}), sh("dialog-events", e.dialogEvents.concat([Jr(Ks(), ( (e, t) => {
      ...
      , TL = e => Kh.sketch({
        ...
        buttonBehaviours: Ml([vk.config({}), kx.config(e.tooltips.getConfig({
      ...
      , PL = e => j(e, ( (e, t) => "menu" === t.type ? j(t.items, ( (e, t) => (e[t.name] = t.storage,
    e)), e) : e), {})
      , UL = (e, t) => [Yr(Ks(), i_), e(Ok, ( (e, o, n, s) => {
        Pl(bt(s.element)).fold(b, Vl),
        t.onClose(),
        o.onClose()
    }
    )), e(_k, ( (e, t, o, n) => {
    ...
    )), jr(Mk, ( (e, o) => t.onUnblock())), jr(Ak, ( (e, o) => t.onBlock(o.event)))]
      , WL = (e, t, o) => {
        ...
        ;
        return [...UL(n, t), n(Ek, ( (e, t) => t.onSubmit(e))), n(Ck, ( (e, t, o) => {
            t.onChange(e, {
                name: o.name
            })
        }
            ...
            Pl(i).fold(r, (e => {
                a(e) || l.exists((t => tt(e, t) && a(t))) ? r() : o().toOptional().filter((t => !tt(t.element, e))).each(r)
            }
            ))
        }
        )), n(Dk, ( (e, t, o) => {
        ...
        const n = t => {
          ...
          , s = {
            ...
            setData: t => {
                n((n => {
                    const r = s.getData()
                      ...
                      , i = ( (e, t) => {
                        const o = e.getRoot();
                        return ZN.getState(o).get().map((e => Kn(Xn("data", e.dataValidator, t)))).getOr(t)
                    }
                    )(e, a)
                      , l = e.getFormWrapper();
                    wu.setValue(l, i),
            ...
            showTab: t => {
                n((o => {
                    const n = e.getBody();
                    ZN.getState(n).get().exists((e => e.isTabPanel())) && Em.getCurrent(n).each((e => {
                        uL.showTab(e, t)
                    }
                    ))
                }
      ...
      , XL = (e, t, o, n=!1, s) => {
        const r = da("dialog")
          ...
          , c = Ms(l.size)
          , d = NL(c.get()).toArray()
          , u = Zh(( (e, t, o, n) => uk.sketch({
            dom: Jh('<div class="tox-dialog__header"></div>'),
            components: [EL(e, t, A.some(o), n), AL(), TL(n)],
            containerBehaviours: Ml([KF.config({
                mode: "mouse",
                blockerClass: "blocker",
          ...
          , m = Zh(( (e, t, o, n, s) => vL(e, t, A.some(o), n, s))({
            body: l.body,
            initialData: l.initialData
        }, r, i, o, n))
          , g = HL(l.buttons)
          , p = PL(g)
          , h = Ce(0 !== g.length, Zh(( (e, t, o) => GL(e, t, o))({
            buttons: g
        }, r, o)))
          , f = WL(( () => v), {
            onBlock: e => {
          ...
          , b = di({
            ...
            behaviours: Ml([Yp.config({
                ...
                channel: `${c_}-${r}`,
                updateState: (e, t) => (c.set(t.internalDialog.size),
                LL(t.internalDialog.size, e),
                s(),
                A.some(t)),
                initialData: e
            }), ch.config({}), sh("execute-on-form", f.concat([Jr(Ks(), ( (e, t) => {
                Yp.focusIn(e)
            }
            )), jr(Er(), ( (e, t) => {
                e.getSystem().broadcastOn([p_], {
    ...
    const JL = ["insertContent", "setContent", "execCommand", "close", "block", "unblock"]
          ...
          , v = [ZN.config({
            ...
            const t = lc(ze(window), "message", (t => {
                if (h.isSameOrigin(new KL(t.raw.origin))) {
                    ...
                    )(o, x, n) : (e => !ZL(e) && a(e) && ve(e, "mceAction"))(n) && e.onMessage(x, n)
                }
            }
            ));
            b.set(t)
        }
        )), Qr(b.clear)]), Nl.config({
            channels: {
                [g_]: {
                    onReceive: (e, t) => {
      ...
      , oz = (e, t, o) => t && o ? [] : [iM.config({
        ...
        modes: ["top"],
        lazyViewport: t => QS(e, t.element).map((e => ({
            bounds: ek(e),
            optScrollEnv: A.some({
                currentScrollTop: e.element.dom.scrollTop,
                scrollElmTop: Kt(e.element).top
      ...
      , nz = e => {
        const t = e.editor
                ...
                const n = da("dialog")
                  ...
                  , g = {
                    ...
                    extraBehaviours: [ZN.config({
                        channel: `${c_}-${n}`,
                        updateState: (e, t) => (a.set(t.internalDialog.size),
                        LL(t.internalDialog.size, e),
                        A.some(t)),
                        initialData: e
                    })],
          ...
          , a = (n, s, r, a) => YN.open(( (n, i, l) => {
            const c = ez(i, l)
              ...
              , p = di(Yh.sketch({
                ...
                inlineBehaviours: Ml([sh("window-manager-inline-events", [jr(_r(), ( (e, t) => {
                    Rr(g.dialog, _k)
                }
                ))]), ...oz(t, o, u)]),
            ...
            return d.set(p),
            Yh.showWithinBounds(p, ui(g.dialog), {
                anchor: s
            }, ( () => {
          ...
          , i = (o, n, s, r) => YN.open(( (o, a, i) => {
            const l = ez(a, i)
              ...
              , g = di(Yh.sketch({
                ...
                inlineBehaviours: Ml([sh("window-manager-inline-events", [jr(_r(), ( (e, t) => {
                    ...
                    modes: ["top", "bottom"],
                    lazyViewport: e => QS(t, e.element).map((e => ({
                        bounds: ek(e),
                        optScrollEnv: A.some({
                            currentScrollTop: e.element.dom.scrollTop,
                            scrollElmTop: Kt(e.element).top
            ...
            return c.set(g),
            Yh.showWithinBounds(g, ui(m.dialog), {
                anchor: n
            }, ( () => e.backstages.popup.shared.getSink().toOptional().bind((e => {
                const o = QS(t, e.element).map((e => ek(e))).getOr(on())
    ...
    nn.add("silver", (e => {
        ...
        let t = () => on();
        const {dialogs: o, popups: n, renderUI: s} = iR(e, {
        ...
        return {
            renderUI: () => {
                const o = s();
                return QS(e, n.getMothership().element).each((e => {
                    t = () => ek(e)
                }
                )),
                o
            ...
            getNotificationManagerImpl: () => ( (e, t, o) => {
                ...
                return {
                    open: (t, r) => {
                        ...
                        o.add(l),
                        h(t.timeout) && t.timeout > 0 && Xh.setEditorTimeout(e, ( () => {
                            a()
                        }
                        ), t.timeout);
                        const c = {
