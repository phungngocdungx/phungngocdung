...
!function() {
    ...
    const Ie = e => e.length > 0
      ...
      , Je = e => {
        ...
        var l;
        const n = (l = e,
        L(l, 0)).map((e => e.element)).bind($e).bind(Ge).getOr({});
        let r = 0
          , a = 0
          , s = 0;
        ...
        const {columns: m, colgroups: d} = (e => L(e, e.length - 1))(c).map((e => {
            const t = (e => {
                const t = {};
                let o = 0;
                return P(e.cells, (e => {
    ...
    const Ht = (e, t, o, l) => {
      ...
      , $t = {
        ...
        attrs: d({
            ...
            copyTo: (e, t) => {
                ...
                )(t, E(e.dom.attributes, ( (e, t) => (e[t.name] = t.value,
                e)), {}))
            }
        }),
        insert: d({
      ...
      , zt = (e, t, o) => ue(e, t).bind((t => ue(e, o).bind((e => {
        return (o = Wt,
        l = [t, e],
        ( (e, t, o) => o.length > 0 ? ( (e, t, o, l) => l(e, t, o[0], o.slice(1)))(e, t, o, Ht) : y.none())($t, ( (e, t) => o(t)), l)).map((o => ({
            first: t,
            last: e,
            table: o
        })));
      ...
      , po = e => {
        if ("transparent" === e)
            return y.some(mo(0, 0, 0, 0));
        const t = co.exec(e);
        if (null !== t)
            return y.some(uo(t[1], t[2], t[3], "1"));
        const o = io.exec(e);
      ...
      , To = (e, t, o) => {
        const l = M(t, (e => {
            return {
                ...
                value: "#" + (o = e.value,
                (t = o,
                (e => lo.test(e) || no.test(e))(t) ? y.some({
                    value: ro(t)
      ...
      , ko = (e, t, o) => {
        const l = (e => {
            ...
            return (l = t,
            ( (e, t, o=h) => o(t) ? y.none() : D(e, G(t)) ? y.some(t) : me(t, e.join(","), (e => $(e, "table") || o(e))))(["td", "th"], l, n)).bind((t => Po(e, t))).filter(o);
            var l, n
        }
        )));
        return n = l,
        ...
        e.undoManager.transact(( () => {
            ( (e, t, o, l) => {
                ...
                if (T(n) > 0) {
                    ...
                    $e(V.fromDom(t[0])).each((t => lt(e, t.dom, {
                        structure: o,
                        style: r
                    })))
                }
        ...
        e.undoManager.transact(( () => {
            ...
            if (T(s) > 0) {
                ...
                ( (e, t, o, l) => {
                    ...
                    if (a(o.class) || "mce-no-match" === o.class || (r.class = o.class),
                    s.height = fe(o.height),
                    c ? s.width = fe(o.width) : n.getAttrib(t, "width") && (r.width = (e => e ? e.replace(/px$/, "") : "")(o.width)),
                    c ? (m ? (r.border = 0,
                    s["border-width"] = "") : (s["border-width"] = fe(o.border),
                    r.border = 1),
                    s["border-spacing"] = fe(o.cellspacing)) : (r.border = m ? 0 : o.border,
                    r.cellpadding = o.cellpadding,
                    r.cellspacing = o.cellspacing),
                    c && t.children) {
                        const e = {};
                        if (m ? e["border-width"] = "" : l.border && (e["border-width"] = fe(o.border)),
      ...
      , cl = e => {
        ...
        const n = ee("caption")
          ...
          , s = e => $e(e.element).map((t => {
            const o = Qe(t)
              , l = Eo(o, e).getOr([])
              , n = E(l, ( (e, t) => (t.isLocked && (e.onAny = !0,
