...
!function() {
    ...
    const t = e => t => (e => {
        ...
        (r = String).prototype.isPrototypeOf(n) || (null === (l = o.constructor) || void 0 === l ? void 0 : l.name) === r.name) ? "string" : t;
        var n, o, r, l
    }
    )(t) === e
      , n = e => t => typeof t === e
    ...
    const G = e => s(e) && "a" === e.nodeName.toLowerCase()
      ...
      , Y = (e, t) => (t = t || te(e.selection.getRng())[0] || e.selection.getNode(),
    le(t) ? m.from(e.dom.select("a[href]", t)[0]) : m.from(e.dom.getParent(t, "a[href]")))
      ...
      , re = e => {
        ...
        if (Y(e).exists((e => e.hasAttribute("data-mce-block"))))
            return !1;
      ...
      , ie = (e, t, n) => {
        const o = e.selection.getNode()
          ...
          , l = ( (e, t) => {
            ...
            return m.from(n.target).isNone() && !1 === A(e) && (n.target = O(e)),
            n.href = ( (e, t) => "http" !== t && "https" !== t || W(e) ? e : t + "://" + e)(n.href, _(e)),
            n
        }
        )(e, (e => {
            return t = ["title", "rel", "class", "target"],
            n = (t, n) => (e[n].each((e => {
      ...
      , ue = (e, t) => {
        ...
        if (o) {
            ...
            r && (null === (n = r.parentNode) || void 0 === n || n.insertBefore(o, r),
            e.dom.remove(r))
        }
    }
      , ge = (e, t, n) => {
      ...
      , me = (e, t) => {
        ...
        return {
            onChange: (e, t) => {
                ...
                return "url" === r ? (e => {
                    const t = (o = e.url,
                    y(n.text.length <= 0, m.from(null === (r = o.meta) || void 0 === r ? void 0 : r.text).getOr(o.value)));
                    var o, r;
                    const l = (e => {
                        var t;
                ...
                )(e()) : ( (e, t) => h.call(e, t))(["anchor", "link"], r) > -1 ? o(e(), r) : "text" === r || "title" === r ? (n[r] = e()[r],
                m.none()) : m.none()
            }
        }
    }
    ...
    const fe = e => {
      ...
      , Ce = (e, t) => (e => {
        ...
        )).then((e => e.bind(K(t)).map((e => e.length > 0 ? [{
            text: "None",
            value: ""
        }].concat(e) : e))))
    }
            ...
            return ( (e, t, n) => {
                ...
                return {
                    ...
                    body: {
                        ...
                        }], o, r, x([i.anchor.map(j("anchor", "Anchors")), i.rels.map(j("rel", "Rel")), i.targets.map(j("target", "Open link in...")), i.link.map(j("link", "Link list")), i.classes.map(j("linkClass", "Class"))])])
                    },
                    buttons: [{
                        type: "cancel",
                        name: "cancel",
    ...
    () => e.off("NodeChange", t))
      ...
      , Be = e => t => {
        const n = e.dom.getParents(e.selection.getStart())
          , o = n => {
            t.setEnabled((t => {
                return oe(t) || (n = e.selection.getRng(),
                te(n).length > 0);
                var n
            }
    ...
    e.add("link", (e => {
        ...
        (e => {
            e.on("click", (t => {
                ...
                n && Ne.metaKeyPressed(t) && (t.preventDefault(),
                Ee(e, n))
            }
            )),
            e.on("keydown", (t => {
