...
!function() {
    ...
    const t = e => t => (e => {
        ...
        (a = String).prototype.isPrototypeOf(r) || (null === (s = o.constructor) || void 0 === s ? void 0 : s.name) === a.name) ? "string" : t;
        var r, o, a, s
    }
    )(t) === e
      , r = t("string")
    ...
    const M = (e, t={}) => A({
      ...
      , B = e => {
        ...
        return t.length > 0 ? j.extend({}, t[0], {
            url: I(t[0], e)
        }) : null
    }
      , G = (e, t) => {
        var r;
        const o = j.extend({}, t);
        if (!o.source && (j.extend(o, T(null !== (r = o.embed) && void 0 !== r ? r : "", e.schema)),
        !o.source))
            return "";
            ...
            return P(o.embed, o, !0, e.schema);
        {
            ...
            )(o, a) : "application/x-shockwave-flash" === o.sourcemime ? (e => {
            ...
            )(o) : -1 !== o.sourcemime.indexOf("audio") ? ( (e, t) => t ? t(e) : '<audio controls="controls" src="' + e.source + '">' + (e.altsource ? '\n<source src="' + e.altsource + '"' + (e.altsourcemime ? ' type="' + e.altsourcemime + '"' : "") + " />\n" : "") + "</audio>")(o, t) : ( (e, t) => t ? t(e) : '<video width="' + e.width + '" height="' + e.height + '"' + (e.poster ? ' poster="' + e.poster + '"' : "") + ' controls="controls">\n<source src="' + e.source + '"' + (e.sourcemime ? ' type="' + e.sourcemime + '"' : "") + " />\n" + (e.altsource ? '<source src="' + e.altsource + '"' + (e.altsourcemime ? ' type="' + e.altsourcemime + '"' : "") + " />\n" : "") + "</video>")(o, r)
        }
    }
      ...
      , J = (e, t) => {
        const r = y(e);
        return r ? ( (e, t, r) => new Promise(( (o, a) => {
            const s = r => (r.html && (q[e.source] = r),
            o({
                url: e.source,
                html: r.html ? r.html : t(e)
            }));
            q[e.source] ? s(q[e.source]) : r({
                url: e.source
            }).then(s).catch(a)
        }
        )))(t, H(e), r) : ( (e, t) => Promise.resolve({
            html: t(e),
            url: e.source
        }))(t, H(e))
    }
      , K = (e, t) => {
        ...
        return d(e, "dimensions").each((e => {
            l(["width", "height"], (o => {
                d(t, o).orThunk(( () => d(e, o))).each((e => r[o] = e))
            }
            ))
        }
        )),
      ...
      , Q = (e, t) => {
        const r = t && "dimensions" !== t ? ( (e, t) => d(t, e).bind((e => d(e, "meta"))))(t, e).getOr({}) : {}
          , a = ( (e, t, r) => a => {
            ...
            return {
                [a]: (a === r ? s().bind((e => o(e) ? l(e).orThunk(n) : n().orThunk(( () => i.from(e))))) : n().orThunk(( () => s().bind((e => o(e) ? l(e) : i.from(e)))))).getOr("")
            }
        }
        )(e, r, t);
        return {
      ...
      , re = e => {
        const t = (e => {
            const t = e.selection.getNode()
              , r = W(t) ? e.serializer.serialize(t, {
                selection: !0
            }) : ""
              , o = T(r, e.schema)
              , a = ( () => {
        ...
        const m = {
          ...
          , u = e.windowManager.open({
            ...
            onSubmit: t => {
                ...
                ( (e, t, r) => {
                    var o, a;
                    t.embed = te(e, t) && k(r) ? G(r, {
                        ...t,
                        embed: ""
                    }) : P(null !== (o = t.embed) && void 0 !== o ? o : "", t, !1, r.schema),
                    t.embed && (e.source === t.source || (a = t.source,
                    h(q, a))) ? Z(r, t.embed) : J(r, t).then((e => {
                        Z(r, e.html)
                    }
                    )).catch(X(r))
                }
    ...
    const ae = e => {
      ...
      , ce = (e, t, r) => {
        ...
        for (; s--; ) {
            ...
            (i = t).length >= 9 && i.substr(0, 9) === n) || ("data" !== t && "src" !== t || (o = e.convertURL(o, t)),
      ...
      , ue = e => {
        let t = e;
        for (; t = t.parent; )
            if (t.attr("data-ephox-embed-iri") || me(t))
                return !0;
        return !1
    }
      , de = (e, t, r) => {
    ...
    (e => {
        e.on("PreInit", ( () => {
            ...
            o.addNodeFilter("iframe,video,audio,object,embed", (e => t => {
                let r, o = t.length;
                for (; o--; )
                    r = t[o],
    ...
    (e => {
        ...
        e.on("ObjectResized", (t => {
            ...
            if (r.getAttribute("data-mce-object")) {
                ...
                o && (o = unescape(o),
                r.setAttribute("data-mce-html", escape(P(o, {
